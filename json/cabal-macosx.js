[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA list of exclusions to dependency chasing.  Any library whose\n path contains any exclusion string \u003cem\u003eas a substring\u003c/em\u003e will be\n excluded when chasing dependencies.\n\u003c/p\u003e",
        "fct-module": "Distribution.MacOSX",
        "fct-package": "cabal-macosx",
        "fct-signature": "type",
        "fct-source": "src/Distribution-MacOSX-Common.html#Exclusions",
        "fct-type": "type",
        "title": "Exclusions"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eMac OSX application information.\n\u003c/p\u003e",
        "fct-module": "Distribution.MacOSX",
        "fct-package": "cabal-macosx",
        "fct-signature": "data",
        "fct-source": "src/Distribution-MacOSX-Common.html#MacApp",
        "fct-type": "data",
        "title": "MacApp"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-module": "Distribution.MacOSX",
        "fct-package": "cabal-macosx",
        "fct-signature": "ChaseWithDefaults",
        "fct-source": "src/Distribution-MacOSX-Common.html#ChaseDeps",
        "fct-type": "function",
        "title": "ChaseWithDefaults"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eDo not include any dependencies - a sensible default if not\n distributing your app.\n\u003c/p\u003e",
        "fct-module": "Distribution.MacOSX",
        "fct-package": "cabal-macosx",
        "fct-signature": "DoNotChase",
        "fct-source": "src/Distribution-MacOSX-Common.html#ChaseDeps",
        "fct-type": "function",
        "title": "DoNotChase"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ePost-build hook for OS X application bundles.  Does nothing if\n called on another O/S.\n\u003c/p\u003e",
        "fct-module": "Distribution.MacOSX",
        "fct-package": "cabal-macosx",
        "fct-signature": "[MacApp]-\u003e Args-\u003e BuildFlags-\u003e PackageDescription-\u003e LocalBuildInfo-\u003e IO ()",
        "fct-type": "function",
        "title": "appBundleBuildHook"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ePost-install hook for OS X application bundles.  Copies the\n application bundle (assuming you are also using the appBundleBuildHook)\n to \u003ccode\u003e$prefix/Applications\u003c/code\u003e\n Does nothing if called on another O/S.\n\u003c/p\u003e",
        "fct-module": "Distribution.MacOSX",
        "fct-package": "cabal-macosx",
        "fct-signature": "[MacApp]-\u003e Args-\u003e InstallFlags-\u003e PackageDescription-\u003e LocalBuildInfo-\u003e IO ()",
        "fct-type": "function",
        "title": "appBundleInstallHook"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eControls inclusion of library dependencies for executable and\n \u003ccode\u003e\u003ca\u003eotherBins\u003c/a\u003e\u003c/code\u003e; see below.\n\u003c/p\u003e",
        "fct-module": "Distribution.MacOSX",
        "fct-package": "cabal-macosx",
        "fct-signature": "ChaseDeps",
        "fct-source": "src/Distribution-MacOSX-Common.html#MacApp",
        "fct-type": "function",
        "title": "appDeps"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ePath to icon file, to be copied to \u003ccode\u003eContents/Resources/\u003c/code\u003e in\n the app bundle.  If omitted, no icon will be used.\n\u003c/p\u003e",
        "fct-module": "Distribution.MacOSX",
        "fct-package": "cabal-macosx",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eDefault list of exclusions; excludes OSX standard frameworks,\n libgcc, etc. - basically things which we would expect to be present\n on any functioning OSX installation.\n\u003c/p\u003e",
        "fct-module": "Distribution.MacOSX",
        "fct-package": "cabal-macosx",
        "fct-signature": "Exclusions",
        "fct-source": "src/Distribution-MacOSX-Common.html#defaultExclusions",
        "fct-type": "function",
        "title": "defaultExclusions"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eGiven a \u003ccode\u003e\u003ca\u003eMacApp\u003c/a\u003e\u003c/code\u003e in context, make an application bundle in the\n build area. (for internal use only)\n\u003c/p\u003e",
        "fct-module": "Distribution.MacOSX",
        "fct-package": "cabal-macosx",
        "fct-signature": "AppBuildInfo -\u003e IO ()",
        "fct-source": "src/Distribution-MacOSX.html#makeAppBundle",
        "fct-type": "function",
        "title": "makeAppBundle"
      },
      "index": {
