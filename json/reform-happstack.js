[
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cdiv class=\"doc\"\u003e\u003cp\u003eSupport for using Reform with the Haskell Web Framework Happstack. \u003ca\u003ehttp://happstack.com/\u003c/a\u003e\n\u003c/p\u003e\u003c/div\u003e",
        "fct-module": "Text.Reform.Happstack",
        "fct-package": "reform-happstack",
        "fct-signature": "module",
        "fct-source": "src/Text-Reform-Happstack.html",
        "fct-type": "module",
        "title": "Happstack"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eUtility Function: add a cookie for CSRF protection\n\u003c/p\u003e",
        "fct-module": "Text.Reform.Happstack",
        "fct-package": "reform-happstack",
        "fct-signature": "Text-\u003e m Text",
        "fct-type": "function",
        "title": "addCSRFCookie"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eUtility Function: check that the CSRF cookie and hidden field exist and are equal\n\u003c/p\u003e\u003cp\u003eIf the check fails, this function will call:\n\u003c/p\u003e\u003cpre\u003e escape $ forbidden (toResponse \"CSRF check failed.\")\n\u003c/pre\u003e",
        "fct-module": "Text.Reform.Happstack",
        "fct-package": "reform-happstack",
        "fct-signature": "Text -\u003e m ()",
        "fct-source": "src/Text-Reform-Happstack.html#checkCSRF",
        "fct-type": "function",
        "title": "checkCSRF"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003egenerate the name to use for the csrf cookie\n\u003c/p\u003e\u003cp\u003eCurrently this returns the static cookie \u003ca\u003ereform-csrf\u003c/a\u003e. Using the prefix would allow\n\u003c/p\u003e",
        "fct-module": "Text.Reform.Happstack",
        "fct-package": "reform-happstack",
        "fct-signature": "Text",
        "fct-source": "src/Text-Reform-Happstack.html#csrfName",
        "fct-type": "function",
        "title": "csrfName"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ecreate an \u003ccode\u003e\u003ca\u003eEnvironment\u003c/a\u003e\u003c/code\u003e to be used with \u003ccode\u003e\u003ca\u003erunForm\u003c/a\u003e\u003c/code\u003e\n\u003c/p\u003e",
        "fct-module": "Text.Reform.Happstack",
        "fct-package": "reform-happstack",
        "fct-signature": "Environment m [Input]",
        "fct-source": "src/Text-Reform-Happstack.html#environment",
        "fct-type": "function",
        "title": "environment"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eUtility Function: get CSRF protection cookie\n\u003c/p\u003e",
        "fct-module": "Text.Reform.Happstack",
        "fct-package": "reform-happstack",
        "fct-signature": "Text -\u003e m Text",
        "fct-source": "src/Text-Reform-Happstack.html#getCSRFCookie",
        "fct-type": "function",
        "title": "getCSRFCookie"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003esimilar to 'eitherForm environment' but includes double-submit\n (Cross Site Request Forgery) CSRF protection.\n\u003c/p\u003e\u003cp\u003eThe form must have been created using \u003ccode\u003e\u003ca\u003ehappstackViewForm\u003c/a\u003e\u003c/code\u003e\n\u003c/p\u003e\u003cp\u003esee also: \u003ccode\u003e\u003ca\u003ehappstackViewForm\u003c/a\u003e\u003c/code\u003e\n\u003c/p\u003e",
        "fct-module": "Text.Reform.Happstack",
        "fct-package": "reform-happstack",
        "fct-signature": "([(Text, Text)] -\u003e view -\u003e view)-\u003e Text-\u003e Form m [Input] error view proof a-\u003e m (Either view a)",
        "fct-type": "function",
        "title": "happstackEitherForm"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003esimilar to \u003ccode\u003e\u003ca\u003eviewForm\u003c/a\u003e\u003c/code\u003e but includes double-submit\n (Cross Site Request Forgery) CSRF protection.\n\u003c/p\u003e\u003cp\u003eMust be used with \u003ccode\u003e\u003ca\u003ehappstackEitherForm\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e\u003cp\u003esee also: \u003ccode\u003e\u003ca\u003ehappstackEitherForm\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Text.Reform.Happstack",
        "fct-package": "reform-happstack",
        "fct-signature": "([(Text, Text)] -\u003e view -\u003e view)-\u003e Text-\u003e Form m input error view proof a-\u003e m view",
        "fct-type": "function",
        "title": "happstackViewForm"
      },
      "index": {
