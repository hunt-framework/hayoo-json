[
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cdiv class=\"doc\"\u003e\u003cp\u003ePerform an IO action, and place its result in an \u003ccode\u003e\u003ca\u003eMVar\u003c/a\u003e\u003c/code\u003e.  See\n also \u003ca\u003eControl.Concurrent.STM.TMVarIO\u003c/a\u003e for a \u003ccode\u003eTMVar\u003c/code\u003e version.\n\u003c/p\u003e\u003c/div\u003e",
        "fct-module": "Control.Concurrent.MVarIO",
        "fct-package": "stm-orelse-io",
        "fct-signature": "module",
        "fct-source": "src/Control-Concurrent-MVarIO.html",
        "fct-type": "module",
        "title": "MVarIO"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cdiv class=\"doc\"\u003e\u003cp\u003eChoose between the return value of an IO action and an STM\n operation, depending on which is available first.\n\u003c/p\u003e\u003c/div\u003e",
        "fct-module": "Control.Concurrent.STM.OrElseIO",
        "fct-package": "stm-orelse-io",
        "fct-signature": "module",
        "fct-source": "src/Control-Concurrent-STM-OrElseIO.html",
        "fct-type": "module",
        "title": "OrElseIO"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003e\u003ccode\u003e\u003ccode\u003e\u003ca\u003erunOrTakeTMVar\u003c/a\u003e\u003c/code\u003e io tm = \u003ccode\u003e\u003ca\u003erunOrElse\u003c/a\u003e\u003c/code\u003e io (\u003ccode\u003e\u003ca\u003etakeTMVar\u003c/a\u003e\u003c/code\u003e tm)\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.STM.OrElseIO",
        "fct-package": "stm-orelse-io",
        "fct-signature": "IO a -\u003e TMVar b -\u003e IO (Either a b)",
        "fct-source": "src/Control-Concurrent-STM-OrElseIO.html#runOrTakeTMVar",
        "fct-type": "function",
        "title": "runOrTakeTMVar"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003e\u003ccode\u003e\u003ccode\u003e\u003ca\u003erunOrTakeTMVar'\u003c/a\u003e\u003c/code\u003e tm io = \u003ccode\u003e\u003ca\u003erunOrElse'\u003c/a\u003e\u003c/code\u003e (\u003ccode\u003e\u003ca\u003etakeTMVar\u003c/a\u003e\u003c/code\u003e tm) io\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.STM.OrElseIO",
        "fct-package": "stm-orelse-io",
        "fct-signature": "TMVar a -\u003e IO b -\u003e IO (Either a b)",
        "fct-source": "src/Control-Concurrent-STM-OrElseIO.html#runOrTakeTMVar%27",
        "fct-type": "function",
        "title": "runOrTakeTMVar'"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cdiv class=\"doc\"\u003e\u003cp\u003ePerform an IO action, and place its result in a \u003ccode\u003e\u003ca\u003eTMVar\u003c/a\u003e\u003c/code\u003e.  See\n also \u003ca\u003eControl.Concurrent.MVarIO\u003c/a\u003e for an \u003ccode\u003e\u003ca\u003eMVar\u003c/a\u003e\u003c/code\u003e version.\n\u003c/p\u003e\u003c/div\u003e",
        "fct-module": "Control.Concurrent.STM.TMVarIO",
        "fct-package": "stm-orelse-io",
        "fct-signature": "module",
        "fct-source": "src/Control-Concurrent-STM-TMVarIO.html",
        "fct-type": "module",
        "title": "TMVarIO"
      },
      "index": {
