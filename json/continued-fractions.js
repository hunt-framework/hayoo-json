  ...
  [
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Math-ContinuedFraction.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eA continued fraction.  Constructed by \u003ccode\u003e\u003ca\u003ecf\u003c/a\u003e\u003c/code\u003e or \u003ccode\u003e\u003ca\u003egcf\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
          "module": "Math.ContinuedFraction",
          "name": "CF",
          "package": "continued-fractions",
          "source": "src/Math-ContinuedFraction.html#CF",
          "type": "data"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eExtract the partial denominators of a \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e, normalizing it if necessary so \n that all the partial numerators are 1.\n\u003c/p\u003e",
          "module": "Math.ContinuedFraction",
          "name": "asCF",
          "package": "continued-fractions",
          "signature": "CF a -\u003e (a, [a])",
          "source": "src/Math-ContinuedFraction.html#asCF",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eExtract all the partial numerators and partial denominators of a \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
          "module": "Math.ContinuedFraction",
          "name": "asGCF",
          "package": "continued-fractions",
          "signature": "CF a -\u003e (a, [(a, a)])",
          "source": "src/Math-ContinuedFraction.html#asGCF",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eEvaluate the convergents of a continued fraction using the fundamental\n recurrence formula:\n\u003c/p\u003e\u003cp\u003eA0 = b0, B0 = 1\n\u003c/p\u003e\u003cp\u003eA1 = b1b0 + a1,  B1 = b1\n\u003c/p\u003e\u003cp\u003eA{n+1} = b{n+1}An + a{n+1}A{n-1}\n\u003c/p\u003e\u003cp\u003eB{n+1} = b{n+1}Bn + a{n+1}B{n-1}\n\u003c/p\u003e\u003cp\u003eThe convergents are then Xn = An/Bn\n\u003c/p\u003e",
          "module": "Math.ContinuedFraction",
          "name": "convergents",
          "package": "continued-fractions",
          "signature": "CF a -\u003e [a]",
          "source": "src/Math-ContinuedFraction.html#convergents",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eComputes the even part of a \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e (that is, a new \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e whose convergents are\n the even-indexed convergents of the original).\n\u003c/p\u003e",
          "module": "Math.ContinuedFraction",
          "name": "evenCF",
          "package": "continued-fractions",
          "signature": "CF a -\u003e CF a",
          "source": "src/Math-ContinuedFraction.html#evenCF",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Math-ContinuedFraction.html#lentzWith",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "package": "continued-fractions",
          "signature": "a -\u003e CF a -\u003e [[a]]",
          "source": "src/Math-ContinuedFraction.html#modifiedLentz",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eComputes the odd part of a \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e (that is, a new \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e whose convergents are\n the odd-indexed convergents of the original).\n\u003c/p\u003e",
          "module": "Math.ContinuedFraction",
          "name": "oddCF",
          "package": "continued-fractions",
          "signature": "CF a -\u003e CF a",
          "source": "src/Math-ContinuedFraction.html#oddCF",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eComputes the even and odd parts, respectively, of a \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e.  These are new\n \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003es that have the even-indexed and odd-indexed convergents of the \n original, respectively.\n\u003c/p\u003e",
          "module": "Math.ContinuedFraction",
          "name": "partitionCF",
          "package": "continued-fractions",
          "signature": "CF a -\u003e (CF a, CF a)",
          "source": "src/Math-ContinuedFraction.html#partitionCF",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eApply an equivalence transformation that sets the partial numerators \n of a \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e to the specfied values.  If the input list is too short, the \n rest of the \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e will be unscaled.\n\u003c/p\u003e",
          "module": "Math.ContinuedFraction",
          "name": "setNumerators",
          "package": "continued-fractions",
          "signature": "[a] -\u003e CF a -\u003e CF a",
          "source": "src/Math-ContinuedFraction.html#setNumerators",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eEuler's formula for computing \u003ccode\u003esum (scanl1 (*) xs)\u003c/code\u003e.  \n Successive convergents of the resulting \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e are successive partial sums\n in the series.\n\u003c/p\u003e",
          "module": "Math.ContinuedFraction",
          "name": "sumPartialProducts",
          "package": "continued-fractions",
          "signature": "[a] -\u003e CF a",
          "source": "src/Math-ContinuedFraction.html#sumPartialProducts",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eTruncate a \u003ccode\u003e\u003ca\u003eCF\u003c/a\u003e\u003c/code\u003e to the specified number of partial numerators and denominators.\n\u003c/p\u003e",
          "module": "Math.ContinuedFraction",
          "name": "truncateCF",
          "package": "continued-fractions",
          "signature": "Int -\u003e CF a -\u003e CF a",
          "source": "src/Math-ContinuedFraction.html#truncateCF",
          "type": "function"
        },
        "index": {
