[
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cdiv class=\"doc\"\u003e\u003cp\u003eSnap integration for the WebSockets library\n\u003c/p\u003e\u003c/div\u003e",
        "fct-module": "Network.WebSockets.Snap",
        "fct-package": "websockets-snap",
        "fct-signature": "module",
        "fct-source": "src/Network-WebSockets-Snap.html",
        "fct-type": "module",
        "title": "Snap"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eThe following function escapes from the current \u003ccode\u003e\u003ca\u003eSnap\u003c/a\u003e\u003c/code\u003e handler, and\n continues processing the \u003ccode\u003e\u003ca\u003eWebSockets\u003c/a\u003e\u003c/code\u003e action. The action to be executed\n takes the \u003ccode\u003e\u003ca\u003eRequest\u003c/a\u003e\u003c/code\u003e as a parameter, because snap has already read this\n from the socket.\n\u003c/p\u003e",
        "fct-module": "Network.WebSockets.Snap",
        "fct-package": "websockets-snap",
        "fct-signature": "ServerApp -\u003e m ()",
        "fct-source": "src/Network-WebSockets-Snap.html#runWebSocketsSnap",
        "fct-type": "function",
        "title": "runWebSocketsSnap"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eVariant of \u003ccode\u003e\u003ca\u003erunWebSocketsSnap\u003c/a\u003e\u003c/code\u003e which allows custom options\n\u003c/p\u003e",
        "fct-module": "Network.WebSockets.Snap",
        "fct-package": "websockets-snap",
        "fct-signature": "ConnectionOptions -\u003e ServerApp -\u003e m ()",
        "fct-source": "src/Network-WebSockets-Snap.html#runWebSocketsSnapWith",
        "fct-type": "function",
        "title": "runWebSocketsSnapWith"
      },
      "index": {
