[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eAn operator form of \u003ccode\u003e\u003ca\u003ebuffer\u003c/a\u003e\u003c/code\u003e.  In general you should be able to replace\n   any use of \u003ccode\u003e\u003ca\u003e$$\u003c/a\u003e\u003c/code\u003e with \u003ccode\u003e\u003ca\u003e$$&\u003c/a\u003e\u003c/code\u003e and suddenly reap the benefit of\n   concurrency, if your conduits were spending time waiting on each other.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.Async",
        "fct-package": "stm-conduit",
        "fct-signature": "Producer m a -\u003e Consumer a m b -\u003e m b",
        "fct-source": "src/Data-Conduit-Async.html#%24%24%26",
        "fct-type": "function",
        "title": "($$&)"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eDrain input values into an asynchronous action in the base monad via a\n   bounded \u003ccode\u003e\u003ca\u003eTBQueue\u003c/a\u003e\u003c/code\u003e.  This is effectively the dual of \u003ccode\u003e\u003ca\u003egatherFrom\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.Async",
        "fct-package": "stm-conduit",
        "fct-signature": "Int-\u003e (TBQueue (Maybe i) -\u003e m r)-\u003e Consumer i m r",
        "fct-type": "function",
        "title": "drainTo"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-module": "Data.Conduit.TMChan",
        "fct-package": "stm-conduit",
        "fct-signature": "module",
        "fct-source": "src/Data-Conduit-TMChan.html",
        "fct-type": "module",
        "title": "TMChan"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eCombines two sources with an unbounded channel, creating a new source\n   which pulls data from a mix of the two sources: whichever produces first.\n\u003c/p\u003e\u003cp\u003eThe order of the new source's data is undefined, but it will be some\n   combination of the two given sources.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TMChan",
        "fct-package": "stm-conduit",
        "fct-signature": "Source (ResourceT m) a -\u003e Source (ResourceT m) a -\u003e ResourceT m (Source (ResourceT m) a)",
        "fct-source": "src/Data-Conduit-TMChan.html#%3E%3D%3C",
        "fct-type": "function",
        "title": "(\u003e=\u003c)"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eMerges a list of sources, putting them all into a bounded channel, and\n   returns a source which can be pulled from to pull from all the given\n   sources in a first-come-first-serve basis.\n\u003c/p\u003e\u003cp\u003eThe order of the new source's data is undefined, but it will be some\n   combination of the given sources.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TMChan",
        "fct-package": "stm-conduit",
        "fct-signature": "[Source (ResourceT m) a]-\u003e Int-\u003e ResourceT m (Source (ResourceT m) a)",
        "fct-type": "function",
        "title": "mergeSources"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a TBMChan. As data is pushed into the sink, it\n   will magically begin to appear in the channel. If the channel is full,\n   the sink will block until space frees up.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TMChan",
        "fct-package": "stm-conduit",
        "fct-signature": "TBMChan a-\u003e Bool-\u003e Sink a m ()",
        "fct-type": "function",
        "title": "sinkTBMChan"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a TMChan. As data is pushed into this sink, it\n   will magically begin to appear in the channel.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TMChan",
        "fct-package": "stm-conduit",
        "fct-signature": "TMChan a-\u003e Bool-\u003e Sink a m ()",
        "fct-type": "function",
        "title": "sinkTMChan"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a TMChan. As data is pushed into the channel, the\n   source will read it and pass it down the conduit pipeline. When the\n   channel is closed, the source will close also.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TMChan",
        "fct-package": "stm-conduit",
        "fct-signature": "TMChan a -\u003e Source m a",
        "fct-source": "src/Data-Conduit-TMChan.html#sourceTMChan",
        "fct-type": "function",
        "title": "sourceTMChan"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a \u003ca\u003eTBMQueue\u003c/a\u003e. As data is pushed into this sink, it\n   will magically begin to appear in the queue.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TQueue",
        "fct-package": "stm-conduit",
        "fct-signature": "TBMQueue a-\u003e Bool-\u003e Sink a m ()",
        "fct-type": "function",
        "title": "sinkTBMQueue"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a \u003ca\u003eTBQueue\u003c/a\u003e. As data is pushed into this sink, it\n   will magically begin to appear in the queue. Boolean argument is used\n   to specify if queue should be closed when the sink is closed.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TQueue",
        "fct-package": "stm-conduit",
        "fct-signature": "TBQueue a -\u003e Sink a m ()",
        "fct-source": "src/Data-Conduit-TQueue.html#sinkTBQueue",
        "fct-type": "function",
        "title": "sinkTBQueue"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a \u003ca\u003eTMQueue\u003c/a\u003e. As data is pushed into this sink, it\n   will magically begin to appear in the queue.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TQueue",
        "fct-package": "stm-conduit",
        "fct-signature": "TMQueue a-\u003e Bool-\u003e Sink a m ()",
        "fct-type": "function",
        "title": "sinkTMQueue"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a \u003ca\u003eTQueue\u003c/a\u003e. As data is pushed into this sink, it\n   will magically begin to appear in the queue.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TQueue",
        "fct-package": "stm-conduit",
        "fct-signature": "TQueue a -\u003e Sink a m ()",
        "fct-source": "src/Data-Conduit-TQueue.html#sinkTQueue",
        "fct-type": "function",
        "title": "sinkTQueue"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a \u003ca\u003eTBMQueue\u003c/a\u003e. As data is pushed into the queue, the\n   source will read it and pass it down the conduit pipeline. When the\n   queue is closed, the source will close also.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TQueue",
        "fct-package": "stm-conduit",
        "fct-signature": "TBMQueue a -\u003e Source m a",
        "fct-source": "src/Data-Conduit-TQueue.html#sourceTBMQueue",
        "fct-type": "function",
        "title": "sourceTBMQueue"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a \u003ca\u003eTBQueue\u003c/a\u003e. As data is pushed into the queue, the\n   source will read it and pass it down the conduit pipeline.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TQueue",
        "fct-package": "stm-conduit",
        "fct-signature": "TBQueue a -\u003e Source m a",
        "fct-source": "src/Data-Conduit-TQueue.html#sourceTBQueue",
        "fct-type": "function",
        "title": "sourceTBQueue"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a \u003ca\u003eTMQueue\u003c/a\u003e. As data is pushed into the queue, the\n   source will read it and pass it down the conduit pipeline. When the\n   queue is closed, the source will close also.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TQueue",
        "fct-package": "stm-conduit",
        "fct-signature": "TMQueue a -\u003e Source m a",
        "fct-source": "src/Data-Conduit-TQueue.html#sourceTMQueue",
        "fct-type": "function",
        "title": "sourceTMQueue"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA simple wrapper around a \u003ca\u003eTQueue\u003c/a\u003e. As data is pushed into the queue, the\n   source will read it and pass it down the conduit pipeline.\n\u003c/p\u003e",
        "fct-module": "Data.Conduit.TQueue",
        "fct-package": "stm-conduit",
        "fct-signature": "TQueue a -\u003e Source m a",
        "fct-source": "src/Data-Conduit-TQueue.html#sourceTQueue",
        "fct-type": "function",
        "title": "sourceTQueue"
      },
      "index": {
