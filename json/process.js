[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-source": "src/System-Process.html#system",
        "fct-type": "function",
        "title": "system"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cdiv class=\"doc\"\u003e\u003cp\u003eOperations for creating and interacting with sub-processes.\n\u003c/p\u003e\u003c/div\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "module",
        "fct-source": "src/System-Process.html",
        "fct-type": "module",
        "title": "Process"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-package": "process",
        "fct-signature": "data",
        "fct-source": "src/System-Process-Internals.html#CmdSpec",
        "fct-type": "data",
        "title": "CmdSpec"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-package": "process",
        "fct-signature": "data",
        "fct-source": "src/System-Process-Internals.html#CreateProcess",
        "fct-type": "data",
        "title": "CreateProcess"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-package": "process",
        "fct-signature": "data",
        "fct-source": "src/System-Process-Internals.html#ProcessHandle",
        "fct-type": "data",
        "title": "ProcessHandle"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-package": "process",
        "fct-signature": "data",
        "fct-source": "src/System-Process-Internals.html#StdStream",
        "fct-type": "data",
        "title": "StdStream"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ethe filename of an executable with a list of arguments.\n see \u003ccode\u003e\u003ca\u003eproc\u003c/a\u003e\u003c/code\u003e for the precise interpretation of\n the \u003ccode\u003eFilePath\u003c/code\u003e field.\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "RawCommand FilePath [String]",
        "fct-source": "src/System-Process-Internals.html#CmdSpec",
        "fct-type": "function",
        "title": "RawCommand"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ea command line to execute using the shell\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "ShellCommand String",
        "fct-source": "src/System-Process-Internals.html#CmdSpec",
        "fct-type": "function",
        "title": "ShellCommand"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eClose all file descriptors except stdin, stdout and stderr in the new process (on Windows, only works if std_in, std_out, and std_err are all Inherit)\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "Bool",
        "fct-source": "src/System-Process-Internals.html#CreateProcess",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eExecutable & arguments, or shell command\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "CmdSpec",
        "fct-source": "src/System-Process-Internals.html#CreateProcess",
        "fct-type": "function",
        "title": "cmdspec"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eCreate a new process group\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "Bool",
        "fct-source": "src/System-Process-Internals.html#CreateProcess",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eOptional path to the working directory for the new process\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eDelegate control-C handling. Use this for interactive console processes to let them handle control-C themselves (see below for details).\n\u003c/p\u003e\u003cp\u003eOn Windows this has no effect.\n\u003c/p\u003e\u003cp\u003e\u003cem\u003eSince: 1.2.0.0\u003c/em\u003e\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "Bool",
        "fct-source": "src/System-Process-Internals.html#CreateProcess",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eOptional environment (otherwise inherit from the current process)\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eThis is a non-blocking version of \u003ccode\u003e\u003ca\u003ewaitForProcess\u003c/a\u003e\u003c/code\u003e.  If the process is\nstill running, \u003ccode\u003e\u003ca\u003eNothing\u003c/a\u003e\u003c/code\u003e is returned.  If the process has exited, then\n\u003ccode\u003e\u003ccode\u003e\u003ca\u003eJust\u003c/a\u003e\u003c/code\u003e e\u003c/code\u003e is returned where \u003ccode\u003ee\u003c/code\u003e is the exit code of the process.\n\u003c/p\u003e\u003cp\u003eOn Unix systems, see \u003ccode\u003e\u003ca\u003ewaitForProcess\u003c/a\u003e\u003c/code\u003e for the meaning of exit codes\nwhen the process died as the result of a signal.\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "ProcessHandle -\u003e IO (Maybe ExitCode)",
        "fct-source": "src/System-Process.html#getProcessExitCode",
        "fct-type": "function",
  ...
  },
  {
    "cmd": "update",
    "document": {
      "uri": "http://hackage.haskell.org/package/process/docs/System-Process.html#v:rawSystem",
      "description": {
        "fct-descr": "\u003cp\u003eThe computation \u003ccode\u003e\u003ccode\u003e\u003ca\u003erawSystem\u003c/a\u003e\u003c/code\u003e \u003cem\u003ecmd\u003c/em\u003e \u003cem\u003eargs\u003c/em\u003e\u003c/code\u003e runs the operating system command\n\u003ccode\u003e\u003cem\u003ecmd\u003c/em\u003e\u003c/code\u003e in such a way that it receives as arguments the \u003ccode\u003e\u003cem\u003eargs\u003c/em\u003e\u003c/code\u003e strings\nexactly as given, with no funny escaping or shell meta-syntax expansion.\nIt will therefore behave more portably between operating systems than \u003ccode\u003e\u003ca\u003esystem\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e\u003cp\u003eThe return codes and possible failures are the same as for \u003ccode\u003e\u003ca\u003esystem\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eRuns a command using the shell.\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "String -\u003e IO ProcessHandle",
        "fct-source": "src/System-Process.html#runCommand",
        "fct-type": "function",
        "title": "runCommand"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "String -\u003e CreateProcess",
        "fct-source": "src/System-Process.html#shell",
        "fct-type": "function",
        "title": "shell"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eCreates a new process to run the specified shell command.\n It does not wait for the program to finish, but returns the \u003ccode\u003e\u003ca\u003eProcessHandle\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e\u003cp\u003e\u003cem\u003eSince: 1.2.0.0\u003c/em\u003e\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "String -\u003e IO ProcessHandle",
        "fct-source": "src/System-Process.html#spawnCommand",
        "fct-type": "function",
        "title": "spawnCommand"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eCreates a new process to run the specified raw command with the given\n arguments. It does not wait for the program to finish, but returns the\n \u003ccode\u003e\u003ca\u003eProcessHandle\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e\u003cp\u003e\u003cem\u003eSince: 1.2.0.0\u003c/em\u003e\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "FilePath -\u003e [String] -\u003e IO ProcessHandle",
        "fct-source": "src/System-Process.html#spawnProcess",
        "fct-type": "function",
        "title": "spawnProcess"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eHow to determine stderr\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "StdStream",
        "fct-source": "src/System-Process-Internals.html#CreateProcess",
        "fct-type": "function",
        "title": "std_err"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eHow to determine stdin\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "StdStream",
        "fct-source": "src/System-Process-Internals.html#CreateProcess",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eHow to determine stdout\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
        "fct-signature": "StdStream",
        "fct-source": "src/System-Process-Internals.html#CreateProcess",
  ...
  },
  {
    "cmd": "update",
    "document": {
      "uri": "http://hackage.haskell.org/package/process/docs/System-Process.html#v:system",
      "description": {
        "fct-descr": "\u003cp\u003eComputation \u003ccode\u003esystem cmd\u003c/code\u003e returns the exit code produced when the\noperating system runs the shell command \u003ccode\u003ecmd\u003c/code\u003e.\n\u003c/p\u003e\u003cp\u003eThis computation may fail with one of the following\n\u003ccode\u003e\u003ca\u003eIOErrorType\u003c/a\u003e\u003c/code\u003e exceptions:\n\u003c/p\u003e\u003cdl\u003e\u003cdt\u003e\u003ccode\u003ePermissionDenied\u003c/code\u003e\u003c/dt\u003e\u003cdd\u003e\nThe process has insufficient privileges to perform the operation.\n\u003c/dd\u003e\u003cdt\u003e\u003ccode\u003eResourceExhausted\u003c/code\u003e\u003c/dt\u003e\u003cdd\u003e\nInsufficient resources are available to perform the operation.\n\u003c/dd\u003e\u003cdt\u003e\u003ccode\u003eUnsupportedOperation\u003c/code\u003e\u003c/dt\u003e\u003cdd\u003e\nThe implementation does not support system calls.\n\u003c/dd\u003e\u003c/dl\u003e\u003cp\u003eOn Windows, \u003ccode\u003e\u003ca\u003esystem\u003c/a\u003e\u003c/code\u003e passes the command to the Windows command\ninterpreter (\u003ccode\u003eCMD.EXE\u003c/code\u003e or \u003ccode\u003eCOMMAND.COM\u003c/code\u003e), hence Unixy shell tricks\nwill not work.\n\u003c/p\u003e\u003cp\u003eOn Unix systems, see \u003ccode\u003e\u003ca\u003ewaitForProcess\u003c/a\u003e\u003c/code\u003e for the meaning of exit codes\nwhen the process died as the result of a signal.\n\u003c/p\u003e",
        "fct-module": "System.Process",
        "fct-package": "process",
