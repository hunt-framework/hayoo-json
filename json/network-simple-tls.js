[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eAbstract type representing the configuration settings for a TLS client.\n\u003c/p\u003e\u003cp\u003eUse \u003ccode\u003e\u003ca\u003emakeClientSettings\u003c/a\u003e\u003c/code\u003e or \u003ccode\u003e\u003ca\u003egetDefaultClientSettings\u003c/a\u003e\u003c/code\u003e to obtain your\n \u003ccode\u003e\u003ca\u003eClientSettings\u003c/a\u003e\u003c/code\u003e value.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "data",
        "fct-source": "src/Network-Simple-TCP-TLS.html#ClientSettings",
        "fct-type": "data",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ePrimary certificate, private key and the rest of the certificate chain.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "data",
        "fct-source": "src/Network-Simple-TCP-TLS.html#Credential",
        "fct-type": "data",
        "title": "Credential"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eAbstract type representing the configuration settings for a TLS server.\n\u003c/p\u003e\u003cp\u003eUse \u003ccode\u003e\u003ca\u003emakeServerSettings\u003c/a\u003e\u003c/code\u003e to obtain your \u003ccode\u003e\u003ca\u003eServerSettings\u003c/a\u003e\u003c/code\u003e value, and\n \u003ccode\u003e\u003ca\u003eupdateServerParams\u003c/a\u003e\u003c/code\u003e to update it.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "data",
        "fct-source": "src/Network-Simple-TCP-TLS.html#ServerSettings",
        "fct-type": "data",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "Credential !X509 !PrivateKey [X509]",
        "fct-source": "src/Network-Simple-TCP-TLS.html#Credential",
        "fct-type": "function",
        "title": "Credential"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003eaccept\u003c/a\u003e\u003c/code\u003e, except it uses a different thread to performs the TLS\n handshake and run the given computation.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "ServerSettings-\u003e Socket-\u003e ((Context, SockAddr) -\u003e IO ())-\u003e m ThreadId",
        "fct-type": "function",
        "title": "acceptFork"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA \u003ccode\u003e\u003ca\u003eLens\u003c/a\u003e\u003c/code\u003e into the TLS client configuration \u003ccode\u003e\u003ca\u003eParams\u003c/a\u003e\u003c/code\u003e.\n See the \u003ca\u003eNetwork.TLS\u003c/a\u003e and the \u003ccode\u003elens\u003c/code\u003e package for details.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "(Params -\u003e f Params) -\u003e ClientSettings -\u003e f ClientSettings",
        "fct-source": "src/Network-Simple-TCP-TLS.html#clientParams",
        "fct-type": "function",
        "title": "clientParams"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eConnect to a TLS-secured TCP server and use the connection\n\u003c/p\u003e\u003cp\u003eA TLS handshake is performed immediately after establishing the TCP\n connection and the TLS and TCP connections are properly closed when done or\n in case of exceptions. If you need to manage the lifetime of the connection\n resources yourself, then use \u003ccode\u003e\u003ca\u003econnectTls\u003c/a\u003e\u003c/code\u003e instead.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eConvert client \u003ccode\u003e\u003ca\u003eCredential\u003c/a\u003e\u003c/code\u003e to the format expected by \u003ccode\u003e\u003ca\u003epCertificates\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "Credential -\u003e [(X509, Maybe PrivateKey)]",
        "fct-source": "src/Network-Simple-TCP-TLS.html#credentialToCertList",
        "fct-type": "function",
        "title": "credentialToCertList"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eGet the system default \u003ccode\u003e\u003ca\u003eClientSettings\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e\u003cp\u003eSee \u003ccode\u003e\u003ca\u003emakeClientSettings\u003c/a\u003e\u003c/code\u003e for the for the default TLS settings used.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "m ClientSettings",
        "fct-source": "src/Network-Simple-TCP-TLS.html#getDefaultClientSettings",
        "fct-type": "function",
        "title": "getDefaultClientSettings"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eMake a client-side TLS \u003ccode\u003e\u003ca\u003eContext\u003c/a\u003e\u003c/code\u003e for the given settings, on top of the\n given TCP \u003ccode\u003e\u003ca\u003eSocket\u003c/a\u003e\u003c/code\u003e connected to the remote end.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "ClientSettings -\u003e Socket -\u003e m Context",
        "fct-source": "src/Network-Simple-TCP-TLS.html#makeClientContext",
        "fct-type": "function",
        "title": "makeClientContext"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eMake a server-side TLS \u003ccode\u003e\u003ca\u003eContext\u003c/a\u003e\u003c/code\u003e for the given settings, on top of the\n given TCP \u003ccode\u003e\u003ca\u003eSocket\u003c/a\u003e\u003c/code\u003e connected to the remote end.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "ServerSettings -\u003e Socket -\u003e m Context",
        "fct-source": "src/Network-Simple-TCP-TLS.html#makeServerContext",
        "fct-type": "function",
        "title": "makeServerContext"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eReceives decrypted bytes from the given \u003ccode\u003e\u003ca\u003eContext\u003c/a\u003e\u003c/code\u003e. Returns \u003ccode\u003e\u003ca\u003eNothing\u003c/a\u003e\u003c/code\u003e\n on EOF.\n\u003c/p\u003e\u003cp\u003eUp to \u003ccode\u003e16384\u003c/code\u003e decrypted bytes will be received at once. The TLS connection is\n automatically renegotiated if a \u003cem\u003eClientHello\u003c/em\u003e message is received.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "Context -\u003e m (Maybe ByteString)",
        "fct-source": "src/Network-Simple-TCP-TLS.html#recv",
        "fct-type": "function",
        "title": "recv"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eEncrypts the given strict \u003ccode\u003e\u003ca\u003eByteString\u003c/a\u003e\u003c/code\u003e and sends it through the\n \u003ccode\u003e\u003ca\u003eContext\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "Context -\u003e ByteString -\u003e m ()",
        "fct-source": "src/Network-Simple-TCP-TLS.html#send",
        "fct-type": "function",
        "title": "send"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA \u003ccode\u003e\u003ca\u003eLens\u003c/a\u003e\u003c/code\u003e into the TLS server configuration \u003ccode\u003e\u003ca\u003eParams\u003c/a\u003e\u003c/code\u003e.\n See the \u003ca\u003eNetwork.TLS\u003c/a\u003e and the \u003ccode\u003elens\u003c/code\u003e package for details.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "(Params -\u003e f Params) -\u003e ServerSettings -\u003e f ServerSettings",
        "fct-source": "src/Network-Simple-TCP-TLS.html#serverParams",
        "fct-type": "function",
        "title": "serverParams"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eUpdate advanced TLS client configuration \u003ccode\u003e\u003ca\u003eParams\u003c/a\u003e\u003c/code\u003e.\n See the \u003ca\u003eNetwork.TLS\u003c/a\u003e module for details.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "(Params -\u003e Params) -\u003e ClientSettings -\u003e ClientSettings",
        "fct-source": "src/Network-Simple-TCP-TLS.html#updateClientParams",
        "fct-type": "function",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eUpdate advanced TLS server configuration \u003ccode\u003e\u003ca\u003eParams\u003c/a\u003e\u003c/code\u003e.\n See the \u003ca\u003eNetwork.TLS\u003c/a\u003e module for details.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "(Params -\u003e Params) -\u003e ServerSettings -\u003e ServerSettings",
        "fct-source": "src/Network-Simple-TCP-TLS.html#updateServerParams",
        "fct-type": "function",
        "title": "updateServerParams"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003euseTls\u003c/a\u003e\u003c/code\u003e, except it also fully closes the TCP connection when done.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "((Context, SockAddr) -\u003e m a) -\u003e (Context, SockAddr) -\u003e m a",
        "fct-source": "src/Network-Simple-TCP-TLS.html#useTlsThenClose",
        "fct-type": "function",
        "title": "useTlsThenClose"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eSimilar to \u003ccode\u003e\u003ca\u003euseTlsThenClose\u003c/a\u003e\u003c/code\u003e, except it performs the all the IO actions\n in a new  thread.\n\u003c/p\u003e\u003cp\u003eUse this instead of forking \u003ccode\u003e\u003ca\u003euseTlsThenClose\u003c/a\u003e\u003c/code\u003e yourself, as that won't give\n the right behavior.\n\u003c/p\u003e",
        "fct-module": "Network.Simple.TCP.TLS",
        "fct-package": "network-simple-tls",
        "fct-signature": "((Context, SockAddr) -\u003e IO ()) -\u003e (Context, SockAddr) -\u003e m ThreadId",
        "fct-source": "src/Network-Simple-TCP-TLS.html#useTlsThenCloseFork",
        "fct-type": "function",
        "title": "useTlsThenCloseFork"
      },
      "index": {
