[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eThis class is the main idea behind \u003ccode\u003eFinal\u003c/code\u003e.  \u003ccode\u003efinalV\u003c/code\u003e is in a\n type class, so we we can have to instances, therefore if used\n incorrectly the compiler sees an ambiguity.\n\u003c/p\u003e",
        "fct-module": "Control.Final",
        "fct-package": "final",
        "fct-signature": "class",
        "fct-source": "src/Control-Final.html#FinalClass",
        "fct-type": "class",
        "title": "FinalClass"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA version of atomically, that joins and runFinals.  This is the\n most common usage for the author.  Details and example can be found\n in \u003ca\u003eControl.Final.Example\u003c/a\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.Final",
        "fct-package": "final",
        "fct-signature": "STM (Final (m a)) -\u003e m a",
        "fct-source": "src/Control-Final.html#atomicJoinFinal",
        "fct-type": "function",
        "title": "atomicJoinFinal"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eUse this instead of \u003ccode\u003e\u003ca\u003ereturn\u003c/a\u003e\u003c/code\u003e when you want to mark this point as\n a final return for the corresponding \u003ccode\u003e\u003ca\u003erunFinal\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.Final",
        "fct-package": "final",
        "fct-signature": "x -\u003e m (f x)",
        "fct-source": "src/Control-Final.html#final",
        "fct-type": "function",
        "title": "final"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-package": "final",
        "fct-signature": "a -\u003e f a",
        "fct-source": "src/Control-Final.html#finalV",
        "fct-type": "method",
        "title": "finalV"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eUseful when the final return value is a monadic computation\n itself that after returned has to be joined into the current\n computation.\n\u003c/p\u003e",
        "fct-module": "Control.Final",
        "fct-package": "final",
        "fct-signature": "m (Final (m a)) -\u003e m a",
        "fct-source": "src/Control-Final.html#joinFinal",
        "fct-type": "function",
        "title": "joinFinal"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eUsage example:\n\u003c/p\u003e\u003cpre\u003e pureExample p =\n   runFinalV $ case p of\n     True -\u003e finalV \"quux\"\n     False -\u003e finalV \"foobar\"\n\u003c/pre\u003e",
        "fct-module": "Control.Final",
        "fct-package": "final",
        "fct-signature": "Final a -\u003e a",
        "fct-source": "src/Control-Final.html#runFinalV",
        "fct-type": "function",
        "title": "runFinalV"
      },
      "index": {
