[
  ...
  [
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003ealongside\u003c/a\u003e\u003c/code\u003e but discards the results.\n\u003c/p\u003e",
          "module": "Control.Alternative.Interleave",
          "name": "alongside_",
          "package": "interleave",
          "signature": "InterleaveT f a -\u003e InterleaveT f b -\u003e InterleaveT f ()",
          "source": "src/Control-Alternative-Interleave.html#alongside_",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "package": "interleave",
          "signature": "[InterleaveT f a] -\u003e f [a]",
          "source": "src/Control-Alternative-Interleave.html#engageMany",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eOffers the given list of items, in order.\n\u003c/p\u003e",
          "module": "Control.Alternative.Interleave",
          "name": "inOrder",
          "package": "interleave",
          "signature": "[f a] -\u003e InterleaveT f [a]",
          "source": "src/Control-Alternative-Interleave.html#inOrder",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003einOrder\u003c/a\u003e\u003c/code\u003e, but discards the results.\n\u003c/p\u003e",
          "module": "Control.Alternative.Interleave",
          "name": "inOrder_",
          "package": "interleave",
          "signature": "[f a] -\u003e InterleaveT f ()",
          "source": "src/Control-Alternative-Interleave.html#inOrder_",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Control-Alternative-Interleave.html#once",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003eonce\u003c/a\u003e\u003c/code\u003e but discards the result.\n\u003c/p\u003e",
          "module": "Control.Alternative.Interleave",
          "name": "once_",
          "package": "interleave",
          "signature": "f a -\u003e InterleaveT f ()",
          "source": "src/Control-Alternative-Interleave.html#once_",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003eunlimitedRecurse\u003c/a\u003e\u003c/code\u003e, but does not accumulate a list of results.\n\u003c/p\u003e\u003cp\u003eIf you want to use this with the StateT monad transformer from the mtl library,\n you can call:\n\u003c/p\u003e\u003cpre\u003e unlimitedRecurse (execStateT myStateAction) initialState\n   where\n     myStateAction :: StateT s m a\n     initialState :: s\n\u003c/pre\u003e",
          "module": "Control.Alternative.Interleave",
          "name": "unlimitedRecurse_",
          "package": "interleave",
          "signature": "(a -\u003e f a) -\u003e a -\u003e InterleaveT f ()",
          "source": "src/Control-Alternative-Interleave.html#unlimitedRecurse_",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003eunlimited\u003c/a\u003e\u003c/code\u003e, but discards the output.  Useful if the event is likely\n to occur many times, and you don't need the results.\n\u003c/p\u003e",
          "module": "Control.Alternative.Interleave",
          "name": "unlimited_",
          "package": "interleave",
          "signature": "f a -\u003e InterleaveT f ()",
          "source": "src/Control-Alternative-Interleave.html#unlimited_",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Control-Alternative-Interleave.html#upTo",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003eupTo\u003c/a\u003e\u003c/code\u003e, but discards the results.\n\u003c/p\u003e",
          "module": "Control.Alternative.Interleave",
          "name": "upTo_",
          "package": "interleave",
          "signature": "Int -\u003e f a -\u003e InterleaveT f ()",
          "source": "src/Control-Alternative-Interleave.html#upTo_",
          "type": "function"
        },
        "index": {
