[
  ...
  [
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "Connection",
          "package": "HDBC-mysql",
          "source": "src/Database-HDBC-MySQL-Connection.html#Connection",
          "type": "data"
        },
        "index": {
          "hierarchy": "Database HDBC MySQL",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eConnection information to use with connectMySQL.\n\u003c/p\u003e\u003cp\u003eYou must either supply a host and port, or the full path to a\n     Unix socket.\n\u003c/p\u003e",
          "module": "Database.HDBC.MySQL",
          "name": "MySQLConnectInfo",
          "package": "HDBC-mysql",
          "source": "src/Database-HDBC-MySQL-Connection.html#MySQLConnectInfo",
          "type": "data"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eConnects to a MySQL database using the specified\n     connection information. \n\u003c/p\u003e",
          "module": "Database.HDBC.MySQL",
          "name": "connectMySQL",
          "package": "HDBC-mysql",
          "signature": "MySQLConnectInfo -\u003e IO Connection",
          "source": "src/Database-HDBC-MySQL-Connection.html#connectMySQL",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003ethe \"default\" database name; e.g., \u003ccode\u003e\"emp\"\u003c/code\u003e\n\u003c/p\u003e",
          "module": "Database.HDBC.MySQL",
          "name": "mysqlDatabase",
          "package": "HDBC-mysql",
          "signature": "String",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eThe group name in my.cnf from which it reads options; e.g., \u003ccode\u003e\"test\"\u003c/code\u003e\n\u003c/p\u003e",
          "module": "Database.HDBC.MySQL",
          "name": "mysqlGroup",
          "package": "HDBC-mysql",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eThe server's hostname; e.g., \u003ccode\u003e\"db1.example.com\"\u003c/code\u003e\n\u003c/p\u003e",
          "module": "Database.HDBC.MySQL",
          "name": "mysqlHost",
          "package": "HDBC-mysql",
          "signature": "String",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eThe MySQL password to use for login; e.g., \u003ccode\u003e\"tiger\"\u003c/code\u003e\n\u003c/p\u003e",
          "module": "Database.HDBC.MySQL",
          "name": "mysqlPassword",
          "package": "HDBC-mysql",
          "signature": "String",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eThe port on which to connect to the server; e.g., \u003ccode\u003e3306\u003c/code\u003e\n\u003c/p\u003e",
          "module": "Database.HDBC.MySQL",
          "name": "mysqlPort",
          "package": "HDBC-mysql",
          "signature": "Int",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eThe absolute path of the server's Unix socket; e.g., \u003ccode\u003e\"/var/lib/mysql.sock\"\u003c/code\u003e\n\u003c/p\u003e",
          "module": "Database.HDBC.MySQL",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eThe MySQL username to use for login; e.g., \u003ccode\u003e\"scott\"\u003c/code\u003e\n\u003c/p\u003e",
          "module": "Database.HDBC.MySQL",
          "name": "mysqlUser",
          "package": "HDBC-mysql",
          "signature": "String",
