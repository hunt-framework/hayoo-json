  ...
  [
    {
      ...
      "document": {
        "description": {
          "description": "\u003cdiv class=\"doc\"\u003e\u003cp\u003eDetect the likely character encoding for a stream of bytes using Mozilla's Universal Character Set Detector.\n\u003c/p\u003e\u003c/div\u003e",
          "module": "Codec.Text.Detect",
          "name": "Detect",
          "package": "charsetdetect",
          "source": "src/Codec-Text-Detect.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eDetect the encoding for a \u003ccode\u003e\u003ca\u003eByteString\u003c/a\u003e\u003c/code\u003e and attempt to create a \u003ccode\u003e\u003ca\u003eTextEncoding\u003c/a\u003e\u003c/code\u003e suitable for decoding it.\n\u003c/p\u003e",
          "module": "Codec.Text.Detect",
          "name": "detectEncoding",
          "package": "charsetdetect",
          "signature": "ByteString -\u003e IO (Maybe TextEncoding)",
          "source": "src/Codec-Text-Detect.html#detectEncoding",
          "type": "function"
        },
        "index": {
