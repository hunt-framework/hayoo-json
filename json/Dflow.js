[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA conditional stream: events matching the predicate will be passed to the stream.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "type",
        "fct-source": "src/Control-RTSP.html#Cond",
        "fct-type": "type",
        "title": "Cond"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eReal time events.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "data",
        "fct-source": "src/Control-RTSP.html#Event",
        "fct-type": "data",
        "title": "Event"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eLike \u003ca\u003eexecRTA\u003c/a\u003e, except that output events are accumulated.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "s -\u003e (b -\u003e RTA s c Bool) -\u003e RTSP b c",
        "fct-source": "src/Control-RTSP.html#accumulateRTA",
        "fct-type": "function",
        "title": "accumulateRTA"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eSend each event to all the streams that accept it.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "[Cond a b] -\u003e RTSP a b",
        "fct-source": "src/Control-RTSP.html#cond",
        "fct-type": "function",
        "title": "cond"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eSend each event to the first stream that accepts it, if any.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "[Cond a b] -\u003e RTSP a b",
        "fct-source": "src/Control-RTSP.html#cond1",
        "fct-type": "function",
        "title": "cond1"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eDelay input events by the specified time.\n\u003c/p\u003e\u003cp\u003eUnfortunately this requires O(n) time when there are \u003ccode\u003en\u003c/code\u003e events queued up due to the use of \u003ca\u003eaccumulate\u003c/a\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "NominalDiffTime -\u003e RTSP b b",
        "fct-source": "src/Control-RTSP.html#delay",
        "fct-type": "function",
        "title": "delay"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eDelay input events by the specified time, but given an event stream \u003ccode\u003e{ev1, ev2, ev3...}\u003c/code\u003e, if ev2 arrives before\n ev1 has been emitted then ev1 will be lost.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "NominalDiffTime -\u003e RTSP b b",
        "fct-source": "src/Control-RTSP.html#delay0",
        "fct-type": "function",
        "title": "delay0"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eEmit a value as an event.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "c -\u003e RTA s c ()",
        "fct-source": "src/Control-RTSP.html#emit",
        "fct-type": "function",
        "title": "emit"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eTrue if the first argument is scheduled to emit an event before the second. This makes \u003ccode\u003eEventStream\u003c/code\u003e a poset \n (partially ordered set).  Infix priority 4.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "EventStream b1 c1 -\u003e EventStream b2 c2 -\u003e Bool",
        "fct-source": "src/Control-RTSP.html#emitsBefore",
        "fct-type": "function",
        "title": "emitsBefore"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eTrue if the event stream is guaranteed not to emit any future events, regardless of input.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "EventStream b c -\u003e Bool",
        "fct-source": "src/Control-RTSP.html#esFinished",
        "fct-type": "function",
        "title": "esFinished"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eAll the possible futures of the event stream.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "EventStream b c -\u003e [(Event c, EventStream b c)]",
        "fct-source": "src/Control-RTSP.html#esFutures",
        "fct-type": "function",
        "title": "esFutures"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eMerge the outputs of two event streams.  Input events are delivered\n to both streams.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "EventStream b c -\u003e EventStream b c -\u003e EventStream b c",
        "fct-source": "src/Control-RTSP.html#esMerge",
        "fct-type": "function",
        "title": "esMerge"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ePeek at the events that will be emitted by this EventStream if no incoming event interrupts them.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "EventStream b c -\u003e [Event c]",
        "fct-source": "src/Control-RTSP.html#esPeek",
        "fct-type": "function",
        "title": "esPeek"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eExecute an RTSP in the IO monad. The function returns immediately with an action for pushing events into the RTSP.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "RTSP b (IO ())-\u003e IO (b -\u003e IO ())",
        "fct-type": "function",
        "title": "execRTSP"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eGet the current state.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "RTA s c s",
        "fct-source": "src/Control-RTSP.html#get",
        "fct-type": "function",
        "title": "get"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eTrue if the first event occurs strictly before the second.  This makes \u003ccode\u003eEvent\u003c/code\u003e a poset (partially ordered set).\n Infix priority 4 (the same as other comparison operators).\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "Event a -\u003e Event b -\u003e Bool",
        "fct-source": "src/Control-RTSP.html#isBefore",
        "fct-type": "function",
        "title": "isBefore"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eApply a function to the current state.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "(s -\u003e s) -\u003e RTA s c ()",
        "fct-source": "src/Control-RTSP.html#modify",
        "fct-type": "function",
        "title": "modify"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eGet the current time. This is the event time plus any pauses.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "RTA s c UTCTime",
        "fct-source": "src/Control-RTSP.html#now",
        "fct-type": "function",
        "title": "now"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eAn event stream that never generates anything.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "EventStream b c",
        "fct-source": "src/Control-RTSP.html#nullStream",
        "fct-type": "function",
        "title": "nullStream"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ePause before the next step. This does not actually delay processing; it merely increments the time of any emitted events.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "NominalDiffTime -\u003e RTA s c ()",
        "fct-source": "src/Control-RTSP.html#pause",
        "fct-type": "function",
        "title": "pause"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ePut the current state.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "s -\u003e RTA s c ()",
        "fct-source": "src/Control-RTSP.html#put",
        "fct-type": "function",
        "title": "put"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "Event b -\u003e EventStream b c",
        "fct-source": "src/Control-RTSP.html#RTSP",
        "fct-type": "function",
        "title": "runRTSP"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eExecute an RTSP against a list of events. Useful for testing.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "RTSP b c-\u003e [Event b]-\u003e [Event c]",
        "fct-type": "function",
        "title": "simulateRTSP"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA pure function converted into a stream processor\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "(b -\u003e c) -\u003e RTSP b c",
        "fct-source": "src/Control-RTSP.html#stream",
        "fct-type": "function",
        "title": "stream"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eConditional stream execution: only certain events will be accepted.\n\u003c/p\u003e",
        "fct-module": "Control.RTSP",
        "fct-package": "Dflow",
        "fct-signature": "Cond a b -\u003e RTSP a b",
        "fct-source": "src/Control-RTSP.html#streamFilter",
        "fct-type": "function",
        "title": "streamFilter"
      },
      "index": {
