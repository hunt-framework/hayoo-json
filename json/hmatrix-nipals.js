[
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cdiv class=\"doc\"\u003e\u003cp\u003eNonlinear Iterative Partial Least Squares\n\u003c/p\u003e\u003c/div\u003e",
        "fct-module": "Numeric.LinearAlgebra.NIPALS",
        "fct-package": "hmatrix-nipals",
        "fct-signature": "module",
        "fct-source": "src/Numeric-LinearAlgebra-NIPALS.html",
        "fct-type": "module",
        "title": "NIPALS"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eCalculate the residuals of a series of samples given a component\n and score vector.\n\u003c/p\u003e\u003cpre\u003e (p,t) \u003c- firstPCFromScoresM samplesM (randomVector 0 Gaussian numSamples)\n samples \u003c- samplesM\n let r = residual samples p t\n\u003c/pre\u003e",
        "fct-module": "Numeric.LinearAlgebra.NIPALS",
        "fct-package": "hmatrix-nipals",
        "fct-signature": "[Vector Double]-\u003e Vector Double-\u003e Vector Double-\u003e [Vector Double]",
        "fct-type": "function",
        "title": "residual"
      },
      "index": {
