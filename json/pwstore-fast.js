[
  ...
  [
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eConvert a \u003ccode\u003e\u003ca\u003eSalt\u003c/a\u003e\u003c/code\u003e into a \u003ccode\u003e\u003ca\u003eByteString\u003c/a\u003e\u003c/code\u003e. The resulting \u003ccode\u003e\u003ca\u003eByteString\u003c/a\u003e\u003c/code\u003e will be\n base64-encoded. Most users will not need to use this function.\n\u003c/p\u003e",
          "module": "Crypto.PasswordStore",
          "name": "exportSalt",
          "package": "pwstore-fast",
          "signature": "Salt -\u003e ByteString",
          "source": "src/Crypto-PasswordStore.html#exportSalt",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eGenerate a \u003ccode\u003e\u003ca\u003eSalt\u003c/a\u003e\u003c/code\u003e from 128 bits of data from \u003ccode\u003e/dev/urandom\u003c/code\u003e, with the\n system RNG as a fallback. This is the function used to generate salts by\n \u003ccode\u003e\u003ca\u003emakePassword\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
          "module": "Crypto.PasswordStore",
          "name": "genSaltIO",
          "package": "pwstore-fast",
          "signature": "IO Salt",
          "source": "src/Crypto-PasswordStore.html#genSaltIO",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eConvert a raw \u003ccode\u003e\u003ca\u003eByteString\u003c/a\u003e\u003c/code\u003e into a \u003ccode\u003e\u003ca\u003eSalt\u003c/a\u003e\u003c/code\u003e.\n Use this function with caution, since using a weak salt will result in a\n weak password.\n\u003c/p\u003e",
          "module": "Crypto.PasswordStore",
          "name": "importSalt",
          "package": "pwstore-fast",
          "signature": "ByteString -\u003e Salt",
          "source": "src/Crypto-PasswordStore.html#importSalt",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eIs the format of a password hash valid? Attempts to parse a given password\n hash. Returns \u003ccode\u003e\u003ca\u003eTrue\u003c/a\u003e\u003c/code\u003e if it parses correctly, and \u003ccode\u003e\u003ca\u003eFalse\u003c/a\u003e\u003c/code\u003e otherwise.\n\u003c/p\u003e",
          "module": "Crypto.PasswordStore",
          "name": "isPasswordFormatValid",
          "package": "pwstore-fast",
          "signature": "ByteString -\u003e Bool",
          "source": "src/Crypto-PasswordStore.html#isPasswordFormatValid",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eCreate a \u003ccode\u003e\u003ca\u003eSalt\u003c/a\u003e\u003c/code\u003e from a \u003ccode\u003e\u003ca\u003eByteString\u003c/a\u003e\u003c/code\u003e. The input must be at least 8\n characters, and can contain arbitrary bytes. Most users will not need to use\n this function.\n\u003c/p\u003e",
          "module": "Crypto.PasswordStore",
          "name": "makeSalt",
          "package": "pwstore-fast",
          "signature": "ByteString -\u003e Salt",
          "source": "src/Crypto-PasswordStore.html#makeSalt",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eReturn the strength of a password hash.\n\u003c/p\u003e",
          "module": "Crypto.PasswordStore",
          "name": "passwordStrength",
          "package": "pwstore-fast",
          "signature": "ByteString -\u003e Int",
          "source": "src/Crypto-PasswordStore.html#passwordStrength",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003everifyPasswordWith\u003c/a\u003e\u003c/code\u003e, but uses \u003ccode\u003e\u003ca\u003epbkdf1\u003c/a\u003e\u003c/code\u003e as algorithm.\n\u003c/p\u003e",
          "module": "Crypto.PasswordStore",
          "name": "verifyPassword",
          "package": "pwstore-fast",
          "signature": "ByteString -\u003e ByteString -\u003e Bool",
          "source": "src/Crypto-PasswordStore.html#verifyPassword",
          "type": "function"
        },
        "index": {
