[
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cdiv class=\"doc\"\u003e\u003cp\u003eSupport for making connections via the OpenSSL library.\n\u003c/p\u003e\u003c/div\u003e",
        "fct-module": "Network.HTTP.Client.OpenSSL",
        "fct-package": "http-client-openssl",
        "fct-signature": "module",
        "fct-source": "src/Network-HTTP-Client-OpenSSL.html",
        "fct-type": "module",
        "title": "OpenSSL"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eNote that it is the caller's responsibility to pass in an appropriate\n context. Future versions of http-client-openssl will hopefully include a\n sane, safe default.\n\u003c/p\u003e",
        "fct-module": "Network.HTTP.Client.OpenSSL",
        "fct-package": "http-client-openssl",
        "fct-signature": "IO SSLContext -\u003e ManagerSettings",
        "fct-source": "src/Network-HTTP-Client-OpenSSL.html#opensslManagerSettings",
        "fct-type": "function",
        "title": "opensslManagerSettings"
      },
      "index": {
