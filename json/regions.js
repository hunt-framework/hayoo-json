  ...
  [
    {
      ...
      "document": {
        "description": {
          "description": "\u003cdiv class=\"doc\"\u003e\u003cp\u003eThis module is not intended for end-users. It should only be used by library\n authors wishing to extend this \u003ccode\u003eregions\u003c/code\u003e library.\n\u003c/p\u003e\u003c/div\u003e",
          "module": "Control.Monad.Trans.Region.OnExit",
          "name": "OnExit",
          "package": "regions",
          "source": "src/Control-Monad-Trans-Region-OnExit.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eAn \u003ccode\u003e\u003ca\u003eIO\u003c/a\u003e\u003c/code\u003e computation that closes or finalizes a resource. For example\n \"\u003ccode\u003ehClose someHandle\u003c/code\u003e\" or \"\u003ccode\u003efree somePtr\u003c/code\u003e\".\n\u003c/p\u003e",
          "module": "Control.Monad.Trans.Region.OnExit",
          "name": "Finalizer",
          "package": "regions",
          "source": "src/Control-Monad-Trans-Region-Internal.html#Finalizer",
          "type": "type"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "Unsafe",
          "package": "regions",
          "source": "src/Control-Monad-Trans-Region-Unsafe.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Control-Monad-Trans-Region-Internal.html#unsafeControlIO",
          "type": "function"
        },
        "index": {
          "hierarchy": "Control Monad Trans Region Unsafe",
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Control-Monad-Trans-Region-Internal.html#unsafeLiftControl",
          "type": "function"
        },
        "index": {
          "hierarchy": "Control Monad Trans Region Unsafe",
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Control-Monad-Trans-Region-Internal.html#unsafeLiftControlIO",
          "type": "function"
        },
        "index": {
          "hierarchy": "Control Monad Trans Region Unsafe",
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Control-Monad-Trans-Region-Internal.html#unsafeLiftIOOp",
          "type": "function"
        },
        "index": {
          "hierarchy": "Control Monad Trans Region Unsafe",
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Control-Monad-Trans-Region-Internal.html#unsafeLiftIOOp_",
          "type": "function"
        },
        "index": {
          "hierarchy": "Control Monad Trans Region Unsafe",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cdiv class=\"doc\"\u003e\u003cp\u003eThis modules implements a technique called \u003cem\u003e\"Lightweight monadic regions\"\u003c/em\u003e\n invented by Oleg Kiselyov and Chung-chieh Shan\n\u003c/p\u003e\u003cp\u003eSee: \u003ca\u003ehttp://okmij.org/ftp/Haskell/regions.html#light-weight\u003c/a\u003e\n\u003c/p\u003e\u003c/div\u003e",
          "module": "Control.Monad.Trans.Region",
          "name": "Region",
          "package": "regions",
          "source": "src/Control-Monad-Trans-Region.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Control-Monad-Trans-Region-Internal.html#liftCallCC",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Control-Monad-Trans-Region-Internal.html#liftCatch",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eTransform the computation inside a region.\n\u003c/p\u003e",
          "module": "Control.Monad.Trans.Region",
          "name": "mapRegionT",
          "package": "regions",
          "signature": "(m α -\u003e n β) -\u003e RegionT s m α -\u003e RegionT s n β",
          "source": "src/Control-Monad-Trans-Region-Internal.html#mapRegionT",
          "type": "function"
        },
        "index": {
