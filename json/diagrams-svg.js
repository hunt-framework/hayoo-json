  ...
  [
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Diagrams-Backend-SVG-CmdLine.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "B",
          "package": "diagrams-svg",
          "source": "src/Diagrams-Backend-SVG.html#B",
          "type": "type"
        },
        "index": {
          "hierarchy": "Diagrams Backend SVG CmdLine",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003e\u003ccode\u003eSVG\u003c/code\u003e is simply a token used to identify this rendering backend\n   (to aid type inference).\n\u003c/p\u003e",
          "module": "Diagrams.Backend.SVG.CmdLine",
          "name": "SVG",
          "package": "diagrams-svg",
          "source": "src/Diagrams-Backend-SVG.html#SVG",
          "type": "data"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "defaultMain",
          "package": "diagrams-svg",
          "signature": "Diagram SVG R2 -\u003e IO ()",
          "source": "src/Diagrams-Backend-SVG-CmdLine.html#defaultMain",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "multiMain",
          "package": "diagrams-svg",
          "signature": "[(String, Diagram SVG R2)] -\u003e IO ()",
          "source": "src/Diagrams-Backend-SVG-CmdLine.html#multiMain",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eRender a diagram as an SVG, writing to the specified output file\n   and using the requested size.\n\u003c/p\u003e",
          "module": "Diagrams.Backend.SVG",
          "name": "renderSVG",
          "package": "diagrams-svg",
          "signature": "FilePath -\u003e SizeSpec2D -\u003e Diagram SVG R2 -\u003e IO ()",
          "source": "src/Diagrams-Backend-SVG.html#renderSVG",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "size",
          "package": "diagrams-svg",
          "signature": "Lens' (Options SVG R2) SizeSpec2D",
          "source": "src/Diagrams-Backend-SVG.html#size",
          "type": "function"
        },
        "index": {
          "hierarchy": "Diagrams Backend SVG",
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "name": "svgDefinitions",
          "package": "diagrams-svg",
          "signature": "Lens' (Options SVG R2) (Maybe Svg)",
          "source": "src/Diagrams-Backend-SVG.html#svgDefinitions",
          "type": "function"
        },
        "index": {
          "hierarchy": "Diagrams Backend SVG",
