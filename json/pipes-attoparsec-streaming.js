[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eParsing failed.\n\u003c/p\u003e",
        "fct-module": "Control.Pipe.Attoparsec.Stream",
        "fct-package": "pipes-attoparsec-streaming",
        "fct-signature": "ParseException [String] String",
        "fct-source": "src/Control-Pipe-Attoparsec-Stream.html#StreamException",
        "fct-type": "function",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-module": "Control.Pipe.Attoparsec.Stream",
        "fct-package": "pipes-attoparsec-streaming",
        "fct-signature": "PartialResult (Maybe a) (Maybe (Parser (PartialResult a)))",
        "fct-source": "src/Control-Pipe-Attoparsec-Stream.html#PartialResult",
        "fct-type": "function",
        "title": "PartialResult"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eThis function converts an Attoparsec parser over bytestrings\n which returns a \u003ccode\u003ePartialResult a\u003c/code\u003e into a Pipe that consumes a\n stream of bytestrings and delivers a stream of \u003ccode\u003ea\u003c/code\u003e values.\n\u003c/p\u003e",
        "fct-module": "Control.Pipe.Attoparsec.Stream",
        "fct-package": "pipes-attoparsec-streaming",
        "fct-signature": "Parser (PartialResult a) -\u003e Pipe ByteString a m ()",
        "fct-source": "src/Control-Pipe-Attoparsec-Stream.html#parse",
        "fct-type": "function",
        "title": "parse"
      },
      "index": {
