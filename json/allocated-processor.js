[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eTODO: What's the semantic model for \u003ccode\u003e\u003ccode\u003e\u003ca\u003eIOSink\u003c/a\u003e\u003c/code\u003e a\u003c/code\u003e?\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "type",
        "fct-source": "src/Control-Processor.html#IOSink",
        "fct-type": "type",
        "title": "IOSink"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003e'f --\u003c g' means: split f and feed it into g. Useful for feeding parallelized (***'d) processors.\n For example, a --\u003ca\u003e (b *** c) = a \u003c/a\u003e\u003e\u003e (b &&& c)\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "cat a a1 -\u003e cat (a1, a1) c -\u003e cat a c",
        "fct-source": "src/Control-Processor.html#--%3C",
        "fct-type": "function",
        "title": "(--\u003c)"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "(a -\u003e x -\u003e m x) -\u003e (a -\u003e m x) -\u003e (x -\u003e m b) -\u003e (x -\u003e m ()) -\u003e Processor m a b",
        "fct-source": "src/Control-Processor.html#Processor",
        "fct-type": "function",
        "title": "Processor"
      },
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eChains two processors serially, so one feeds the next.\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "Processor m a b' -\u003e Processor m b' b -\u003e Processor m a b",
        "fct-source": "src/Control-Processor.html#chain",
        "fct-type": "function",
        "title": "chain"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eDifferentiate of time-dependent values, using \u003ccode\u003e\u003ca\u003escanlT\u003c/a\u003e\u003c/code\u003e\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "m (Scalar v) -\u003e Processor m a v -\u003e Processor m a v",
        "fct-source": "src/Control-Processor.html#differentiate",
        "fct-type": "function",
        "title": "differentiate"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "[Scalar a] -\u003e [a] -\u003e a",
        "fct-source": "src/Control-Processor.html#discreteConv",
        "fct-type": "function",
        "title": "discreteConv"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eThe identity processor: output = input. Semantically, [[ empty ]] = id\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "Processor m a a",
        "fct-source": "src/Control-Processor.html#empty",
        "fct-type": "function",
        "title": "empty"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eFinite impulse response\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "[Scalar v] -\u003e t -\u003e m t -\u003e Processor m a v -\u003e Processor m a v",
        "fct-source": "src/Control-Processor.html#fir",
        "fct-type": "function",
        "title": "fir"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eHolds a Maybe-valued processor and reports the time passed since last value was seen.\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "b -\u003e m t -\u003e Processor m a (Maybe b) -\u003e Processor m a (b, t)",
        "fct-source": "src/Control-Processor.html#holdMaybe",
        "fct-type": "function",
        "title": "holdMaybe"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eIntegration of time-dependent values, using \u003ccode\u003e\u003ca\u003escanlT\u003c/a\u003e\u003c/code\u003e, implemented by trapezoidal approximation.\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "m (Scalar v) -\u003e Processor m a v -\u003e Processor m a v",
        "fct-source": "src/Control-Processor.html#integrate",
        "fct-type": "function",
        "title": "integrate"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eRunning maximum of a processor's values\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "m t -\u003e b -\u003e Processor m a b -\u003e Processor m a b",
        "fct-source": "src/Control-Processor.html#maxP",
        "fct-type": "function",
        "title": "maxP"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eRunning minimum of a processor's values\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "m t -\u003e b -\u003e Processor m a b -\u003e Processor m a b",
        "fct-source": "src/Control-Processor.html#minP",
        "fct-type": "function",
        "title": "minP"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "Int -\u003e ([(t, b)] -\u003e c) -\u003e (t, b) -\u003e c -\u003e m t -\u003e Processor m a b -\u003e Processor m a c",
        "fct-source": "src/Control-Processor.html#nStepsMemory",
        "fct-type": "function",
        "title": "nStepsMemory"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA processor that represents two sub-processors in parallel (although the current implementation runs them\n sequentially, but that may change in the future)\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "Processor m a b -\u003e Processor m c d -\u003e Processor m (a, c) (b, d)",
        "fct-source": "src/Control-Processor.html#parallel",
        "fct-type": "function",
        "title": "parallel"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      "uri": "http://hackage.haskell.org/package/allocated-processor/docs/Control-Processor.html#v:processor",
      "description": {
        "fct-descr": "\u003cp\u003eTODO: do we need this? we're exporting the data constructor anyway for now, so maybe we don't.\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "(a -\u003e x -\u003e m x) -\u003e (a -\u003e m x) -\u003e (x -\u003e m b) -\u003e (x -\u003e m ()) -\u003e Processor m a b",
        "fct-source": "src/Control-Processor.html#processor",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eGiven a \u003ccode\u003e\u003ca\u003eholdMaybe\u003c/a\u003e\u003c/code\u003e-type processor, reverts back to a default value if no input was \n seen for more than a given time limit\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "t -\u003e b -\u003e Processor m a (b, t) -\u003e Processor m a b",
        "fct-source": "src/Control-Processor.html#revertAfterT",
        "fct-type": "function",
        "title": "revertAfterT"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eRuns the processor once: allocates, processes, converts to output, and deallocates.\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "Processor m a b -\u003e a -\u003e m b",
        "fct-source": "src/Control-Processor.html#run",
        "fct-type": "function",
        "title": "run"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eKeeps running the processing function in a loop until a predicate on the output is true.\n Useful for processors whose main function is after the allocation and before deallocation.\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "Processor m a b -\u003e a -\u003e (b -\u003e m Bool) -\u003e m b",
        "fct-source": "src/Control-Processor.html#runUntil",
        "fct-type": "function",
        "title": "runUntil"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eRuns the processor once, but passes the processing + conversion action to the given function.\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "(m b -\u003e m b') -\u003e Processor m a b -\u003e a -\u003e m b'",
        "fct-source": "src/Control-Processor.html#runWith",
        "fct-type": "function",
        "title": "runWith"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eSplits (duplicates) the output of a functor, or on this case a processor.\n\u003c/p\u003e",
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "f a -\u003e f (a, a)",
        "fct-source": "src/Control-Processor.html#split",
        "fct-type": "function",
        "title": "split"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-module": "Control.Processor",
        "fct-package": "allocated-processor",
        "fct-signature": "IOProcessor a a",
        "fct-source": "src/Control-Processor.html#trace",
        "fct-type": "function",
        "title": "trace"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-module": "Foreign.ForeignPtrWrap",
        "fct-package": "allocated-processor",
        "fct-signature": "module",
        "fct-source": "src/Foreign-ForeignPtrWrap.html",
        "fct-type": "module",
        "title": "ForeignPtrWrap"
      },
      "index": {
        "description": "",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eFails if the ptr is nullPtr\n\u003c/p\u003e",
        "fct-module": "Foreign.ForeignPtrWrap",
        "fct-package": "allocated-processor",
        "fct-signature": "IO (Ptr a) -\u003e IO (Ptr a)",
        "fct-source": "src/Foreign-ForeignPtrWrap.html#checkPtr",
        "fct-type": "function",
        "title": "checkPtr"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA wrapper for newForeignPtr that handles nullPtrs, and can be chained to an IO Ptr creator.\n\u003c/p\u003e\u003cp\u003eExample usage:\n\u003c/p\u003e\u003cpre\u003e myPtrCreator = (createForeignPtr deallocFunc) . allocFunc\n\u003c/pre\u003e\u003cp\u003ewhere, allocFunc :: a-\u003eb-\u003ec-\u003e...-\u003e IO (Ptr z)\n\u003c/p\u003e",
        "fct-module": "Foreign.ForeignPtrWrap",
        "fct-package": "allocated-processor",
        "fct-signature": "FunPtr (Ptr a -\u003e IO ()) -\u003e IO (Ptr a) -\u003e IO (ForeignPtr a)",
        "fct-source": "src/Foreign-ForeignPtrWrap.html#createForeignPtr",
        "fct-type": "function",
        "title": "createForeignPtr"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eNames a failure\n\u003c/p\u003e",
        "fct-module": "Foreign.ForeignPtrWrap",
        "fct-package": "allocated-processor",
        "fct-signature": "String -\u003e IO a -\u003e IO a",
        "fct-source": "src/Foreign-ForeignPtrWrap.html#errorName",
        "fct-type": "function",
        "title": "errorName"
      },
      "index": {
