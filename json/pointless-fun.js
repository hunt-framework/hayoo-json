[
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cdiv class=\"doc\"\u003e\u003cp\u003ePointless fun :)\n\u003c/p\u003e\u003c/div\u003e",
        "fct-module": "Data.Function.Pointless",
        "fct-package": "pointless-fun",
        "fct-signature": "module",
        "fct-source": "src/Data-Function-Pointless.html",
        "fct-type": "module",
        "title": "Pointless"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eMulticompose a function on the appropriate argument. This is\n like the \u003ccode\u003e-\u003e\u003c/code\u003e arrows in a type signature.\n\u003c/p\u003e",
        "fct-module": "Data.Function.Pointless",
        "fct-package": "pointless-fun",
        "fct-signature": "(a -\u003e b) -\u003e (c -\u003e d) -\u003e (b -\u003e c) -\u003e a -\u003e d",
        "fct-source": "src/Data-Function-Pointless.html#~%3E",
        "fct-type": "function",
        "title": "(~\u003e)"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eLift a function for multicomposition. This is like the \u003ccode\u003e::\u003c/code\u003e\n of a type signature.\n\u003c/p\u003e",
        "fct-module": "Data.Function.Pointless",
        "fct-package": "pointless-fun",
        "fct-signature": "(a -\u003e b) -\u003e ((a -\u003e b) -\u003e c -\u003e d) -\u003e c -\u003e d",
        "fct-source": "src/Data-Function-Pointless.html#%24%3A%3A",
        "fct-type": "function",
        "title": "($::)"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eSecondary composition: compose the right argument on the second\n arg of the left argument.\n\u003c/p\u003e\u003cpre\u003e (f .^ g) x y = f x (g y)\n\u003c/pre\u003e",
        "fct-module": "Data.Function.Pointless",
        "fct-package": "pointless-fun",
        "fct-signature": "(a -\u003e c -\u003e d) -\u003e (b -\u003e c) -\u003e a -\u003e b -\u003e d",
        "fct-source": "src/Data-Function-Pointless.html#.%5E",
        "fct-type": "function",
        "title": "(.^)"
      },
      "index": {
