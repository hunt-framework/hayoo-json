[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eLook up the given name in the (value namespace of the) current splice's scope. See \u003ca\u003eLanguage.Haskell.TH.Syntax\u003c/a\u003e for more details.\n\u003c/p\u003e",
        "fct-module": "NotCPP.LookupValueName",
        "fct-package": "notcpp",
        "fct-signature": "String -\u003e Q (Maybe Name)",
        "fct-type": "function",
        "title": "lookupValueName"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eAn empty type used only to signify a multiparameter typeclass in\n \u003ccode\u003e\u003ca\u003esafeInstance\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "NotCPP.OrphanEvasion",
        "fct-package": "notcpp",
        "fct-signature": "data",
        "fct-source": "src/NotCPP-OrphanEvasion.html#MultiParams",
        "fct-type": "data",
        "title": "MultiParams"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003e\u003ccode\u003e\u003ccode\u003e\u003ca\u003esafeInstance'\u003c/a\u003e\u003c/code\u003e className cxt types methods\u003c/code\u003e produces an instance\n of the given class if and only if one doesn't already exist.\n\u003c/p\u003e\u003cp\u003eSee \u003ccode\u003e\u003ca\u003esafeInstance\u003c/a\u003e\u003c/code\u003e for a simple way to construct the \u003ccode\u003e\u003ca\u003eCxt\u003c/a\u003e\u003c/code\u003e and\n \u003ccode\u003e[\u003ccode\u003e\u003ca\u003eType\u003c/a\u003e\u003c/code\u003e]\u003c/code\u003e parameters.\n\u003c/p\u003e",
        "fct-module": "NotCPP.OrphanEvasion",
        "fct-package": "notcpp",
        "fct-signature": "Name -\u003e Cxt -\u003e [Type] -\u003e Q [Dec] -\u003e Q [Dec]",
        "fct-source": "src/NotCPP-OrphanEvasion.html#safeInstance%27",
        "fct-type": "function",
        "title": "safeInstance'"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eReturns \u003ccode\u003e\u003ccode\u003e\u003ca\u003eJust\u003c/a\u003e\u003c/code\u003e (\u003ccode\u003e\u003ca\u003eVarE\u003c/a\u003e\u003c/code\u003e n)\u003c/code\u003e if the info relates to a value called\n \u003ccode\u003en\u003c/code\u003e, or \u003ccode\u003e\u003ca\u003eNothing\u003c/a\u003e\u003c/code\u003e if it relates to a different sort of thing.\n\u003c/p\u003e",
        "fct-module": "NotCPP.ScopeLookup",
        "fct-package": "notcpp",
        "fct-signature": "Info -\u003e Maybe Exp",
        "fct-source": "src/NotCPP-Utils.html#infoToExp",
        "fct-type": "function",
        "title": "infoToExp"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eTurns \u003ccode\u003e\u003ca\u003eNothing\u003c/a\u003e\u003c/code\u003e into an expression representing \u003ccode\u003e\u003ca\u003eNothing\u003c/a\u003e\u003c/code\u003e, and\n \u003ccode\u003e\u003ccode\u003e\u003ca\u003eJust\u003c/a\u003e\u003c/code\u003e x\u003c/code\u003e into an expression representing \u003ccode\u003e\u003ca\u003eJust\u003c/a\u003e\u003c/code\u003e applied to the\n expression in \u003ccode\u003ex\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "NotCPP.ScopeLookup",
        "fct-package": "notcpp",
        "fct-signature": "Maybe Exp -\u003e Exp",
        "fct-source": "src/NotCPP-Utils.html#liftMaybe",
        "fct-type": "function",
        "title": "liftMaybe"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA useful variant of \u003ccode\u003e\u003ca\u003ereify\u003c/a\u003e\u003c/code\u003e that returns \u003ccode\u003e\u003ca\u003eNothing\u003c/a\u003e\u003c/code\u003e instead of\n halting compilation when an error occurs (e.g. because the given\n name was not in scope).\n\u003c/p\u003e",
        "fct-module": "NotCPP.ScopeLookup",
        "fct-package": "notcpp",
        "fct-signature": "Name -\u003e Q (Maybe Info)",
        "fct-source": "src/NotCPP-Utils.html#maybeReify",
        "fct-type": "function",
        "title": "maybeReify"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eTurns a possibly-failing \u003ccode\u003e\u003ca\u003eQ\u003c/a\u003e\u003c/code\u003e action into one returning a \u003ccode\u003e\u003ca\u003eMaybe\u003c/a\u003e\u003c/code\u003e\n value.\n\u003c/p\u003e",
        "fct-module": "NotCPP.ScopeLookup",
        "fct-package": "notcpp",
        "fct-signature": "Q a -\u003e Q (Maybe a)",
        "fct-source": "src/NotCPP-Utils.html#recoverMaybe",
        "fct-type": "function",
        "title": "recoverMaybe"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eProduces \u003ccode\u003e\u003ccode\u003e\u003ca\u003eJust\u003c/a\u003e\u003c/code\u003e x\u003c/code\u003e if the given string names the value \u003ccode\u003ex\u003c/code\u003e,\n or \u003ccode\u003e\u003ca\u003eNothing\u003c/a\u003e\u003c/code\u003e otherwise.\n\u003c/p\u003e",
        "fct-module": "NotCPP.ScopeLookup",
        "fct-package": "notcpp",
        "fct-signature": "String -\u003e Q (Maybe Exp)",
        "fct-source": "src/NotCPP-ScopeLookup.html#scopeLookup%27",
        "fct-type": "function",
        "title": "scopeLookup'"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eFinds the first string in the list that names a value, and produces\n a spliceable expression of that value, or reports a compile error if\n it fails.\n\u003c/p\u003e",
        "fct-module": "NotCPP.ScopeLookup",
        "fct-package": "notcpp",
        "fct-signature": "[String] -\u003e Q Exp",
        "fct-source": "src/NotCPP-ScopeLookup.html#scopeLookups",
        "fct-type": "function",
        "title": "scopeLookups"
      },
      "index": {
