[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eSpecifies what types are inhabitants of what subkinds.\n\u003c/p\u003e",
        "fct-module": "Data.Kind",
        "fct-package": "kinds",
        "fct-signature": "class",
        "fct-source": "src/Data-Kind.html#Inhabitant",
        "fct-type": "class",
        "title": "Inhabitant"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eThe class of subkind representations.\n\u003c/p\u003e",
        "fct-module": "Data.Kind",
        "fct-package": "kinds",
        "fct-signature": "class",
        "fct-source": "src/Data-Kind.html#Kind",
        "fct-type": "class",
        "title": "Kind"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eRepresents kind&#160;\u003ccode\u003e*\u003c/code\u003e itself.\n\u003c/p\u003e",
        "fct-module": "Data.Kind",
        "fct-package": "kinds",
        "fct-signature": "data",
        "fct-source": "src/Data-Kind.html#KindStar",
        "fct-type": "data",
        "title": "KindStar"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eConversion from a type that uses normal universal quantification into one that uses\n            subkind-specific universal quantification.\n\u003c/p\u003e",
        "fct-module": "Data.Kind",
        "fct-package": "kinds",
        "fct-signature": "item inhabitant) -\u003e All kind item",
        "fct-source": "src/Data-Kind.html#closed",
        "fct-type": "method",
        "title": "closed"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eConversion from a universally quantified type into a type that is fixed to a specific\n            inhabitant.\n\u003c/p\u003e\u003cp\u003eThis method exists to ensure that one cannot extend the subkind. If one would try to add\n            a new inhabitant, one would have to provide an implementation of \u003ccode\u003especialize\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Data.Kind",
        "fct-package": "kinds",
        "fct-signature": "All kind item -\u003e item inhabitant",
        "fct-source": "src/Data-Kind.html#specialize",
        "fct-type": "method",
        "title": "specialize"
      },
      "index": {
