[
  ...
  [
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eA set of functions to change the style of the generated templates.\n\u003c/p\u003e",
          "module": "Text.Bravo",
          "name": "TplOptions",
          "package": "Bravo",
          "source": "src/Text-Bravo-Translate.html#TplOptions",
          "type": "data"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eThe default template generation options used by \u003ccode\u003e\u003ca\u003emkTemplates\u003c/a\u003e\u003c/code\u003e and \u003ccode\u003e\u003ca\u003emkTemplatesFromFile\u003c/a\u003e\u003c/code\u003e.\n An example:\n\u003c/p\u003e\u003cpre\u003e\n     tplMkName defaultTplOptions \"example\"              == \"TplExample\"\n     tplMkFieldName defaultTplOptions \"example\" \"field\" == \"exampleField\"\n     tplModifyText defaultTplOptions                    == id\n\u003c/pre\u003e",
          "module": "Text.Bravo",
          "name": "defaultTplOptions",
          "package": "Bravo",
          "signature": "TplOptions",
          "source": "src/Text-Bravo-Translate.html#defaultTplOptions",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eTransforms a string into a list of template declarations.\n\u003c/p\u003e",
          "module": "Text.Bravo",
          "name": "mkTemplates",
          "package": "Bravo",
          "signature": "String -\u003e Q [Dec]",
          "source": "src/Text-Bravo-Translate.html#mkTemplates",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eReads a file and transforms the read file content into a list of template declarations.\n\u003c/p\u003e",
          "module": "Text.Bravo",
          "name": "mkTemplatesFromFile",
          "package": "Bravo",
          "signature": "FilePath -\u003e Q [Dec]",
          "source": "src/Text-Bravo-Translate.html#mkTemplatesFromFile",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eReads a file and transforms the read file content into a list of template declarations, using\n custom options for the data type generation.\n\u003c/p\u003e",
          "module": "Text.Bravo",
          "name": "mkTemplatesFromFileWithOptions",
          "package": "Bravo",
          "signature": "TplOptions -\u003e FilePath -\u003e Q [Dec]",
          "source": "src/Text-Bravo-Translate.html#mkTemplatesFromFileWithOptions",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eTransforms a string into a list of template declarations, using custom options for the\n data type generation.\n\u003c/p\u003e",
          "module": "Text.Bravo",
          "name": "mkTemplatesWithOptions",
          "package": "Bravo",
          "signature": "TplOptions -\u003e String -\u003e Q [Dec]",
          "source": "src/Text-Bravo-Translate.html#mkTemplatesWithOptions",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eCreates the record field name for a given template name and field name.\n\u003c/p\u003e",
          "module": "Text.Bravo",
          "name": "tplMkFieldName",
          "package": "Bravo",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eCreates the data type and constructor name for a given template name.\n\u003c/p\u003e",
          "module": "Text.Bravo",
          "name": "tplMkName",
          "package": "Bravo",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eThis function is applied to each template text splice, allowing e.g. the\n removal of extra whitespace etc.\n\u003c/p\u003e",
          "module": "Text.Bravo",
          "name": "tplModifyText",
          "package": "Bravo",
          "signature": "String -\u003e String",
