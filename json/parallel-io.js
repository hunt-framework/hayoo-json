[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eWrap any IO action used from your worker threads that may block with this method:\n it temporarily spawns another worker thread to make up for the loss of the old blocked\n worker.\n\u003c/p\u003e\u003cp\u003eSee also \u003ccode\u003e\u003ca\u003eextraWorkerWhileBlocked\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Global",
        "fct-package": "parallel-io",
        "fct-signature": "IO a -\u003e IO a",
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#extraWorkerWhileBlocked",
        "fct-type": "function",
        "title": "extraWorkerWhileBlocked"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eThe global thread pool. Contains as many threads as there are capabilities.\n\u003c/p\u003e\u003cp\u003eUsers of the global pool must call \u003ccode\u003e\u003ca\u003estopGlobalPool\u003c/a\u003e\u003c/code\u003e from the main thread at the end of their program.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Global",
        "fct-package": "parallel-io",
        "fct-signature": "Pool",
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#globalPool",
        "fct-type": "function",
        "title": "globalPool"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eExecute the given actions in parallel on the global thread pool,\n returning the results in the same order as the corresponding actions.\n\u003c/p\u003e\u003cp\u003eUsers of the global pool must call \u003ccode\u003e\u003ca\u003estopGlobalPool\u003c/a\u003e\u003c/code\u003e from the main thread at the end of their program.\n\u003c/p\u003e\u003cp\u003eSee also \u003ccode\u003e\u003ca\u003eparallel\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Global",
        "fct-package": "parallel-io",
        "fct-signature": "[IO a] -\u003e IO [a]",
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#parallel",
        "fct-type": "function",
        "title": "parallel"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#parallelE",
        "fct-type": "function",
        "title": "parallelE"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eExecute the given actions in parallel on the global thread pool, reporting exceptions explicitly.\n\u003c/p\u003e\u003cp\u003eUsers of the global pool must call \u003ccode\u003e\u003ca\u003estopGlobalPool\u003c/a\u003e\u003c/code\u003e from the main thread at the end of their program.\n\u003c/p\u003e\u003cp\u003eSee also \u003ccode\u003e\u003ca\u003eparallelE_\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Global",
        "fct-package": "parallel-io",
        "fct-signature": "[IO a] -\u003e IO [Maybe SomeException]",
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#parallelE_",
        "fct-type": "function",
        "title": "parallelE_"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eRun the list of computations in parallel, returning the result of the first\n thread that completes with (Just x), if any.\n\u003c/p\u003e\u003cp\u003eUsers of the global pool must call \u003ccode\u003e\u003ca\u003estopGlobalPool\u003c/a\u003e\u003c/code\u003e from the main thread at the end of their program.\n\u003c/p\u003e\u003cp\u003eSee also \u003ccode\u003e\u003ca\u003eparallelFirst\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Global",
        "fct-package": "parallel-io",
        "fct-signature": "[IO (Maybe a)] -\u003e IO (Maybe a)",
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#parallelFirst",
        "fct-type": "function",
        "title": "parallelFirst"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-module": "Control.Concurrent.ParallelIO.Global",
        "fct-package": "parallel-io",
        "fct-signature": "[IO (Maybe a)] -\u003e IO (Maybe (Either SomeException a))",
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#parallelFirstE",
        "fct-type": "function",
        "title": "parallelFirstE"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-package": "parallel-io",
        "fct-signature": "[IO a] -\u003e IO [a]",
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#parallelInterleaved",
        "fct-type": "function",
        "title": "parallelInterleaved"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-package": "parallel-io",
        "fct-signature": "[IO a] -\u003e IO [Either SomeException a]",
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#parallelInterleavedE",
        "fct-type": "function",
        "title": "parallelInterleavedE"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#parallel_",
        "fct-type": "function",
        "title": "parallel_"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eIn order to reliably make use of the global parallelism combinators,\n you must invoke this function after all calls to those combinators have\n finished. A good choice might be at the end of \u003ccode\u003emain\u003c/code\u003e.\n\u003c/p\u003e\u003cp\u003eSee also \u003ccode\u003e\u003ca\u003estopPool\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Global",
        "fct-package": "parallel-io",
        "fct-signature": "IO ()",
        "fct-source": "src/Control-Concurrent-ParallelIO-Global.html#stopGlobalPool",
        "fct-type": "function",
        "title": "stopGlobalPool"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA thread pool, containing a maximum number of threads. The best way to\n construct one of these is using \u003ccode\u003e\u003ca\u003ewithPool\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Local",
        "fct-package": "parallel-io",
        "fct-signature": "data",
        "fct-source": "src/Control-Concurrent-ParallelIO-Local.html#Pool",
        "fct-type": "data",
        "title": "Pool"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-module": "Control.Concurrent.ParallelIO.Local",
        "fct-package": "parallel-io",
        "fct-signature": "Pool -\u003e IO ()",
        "fct-source": "src/Control-Concurrent-ParallelIO-Local.html#killPoolWorkerFor",
        "fct-type": "function",
        "title": "killPoolWorkerFor"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eAs \u003ccode\u003e\u003ca\u003eparallel_\u003c/a\u003e\u003c/code\u003e, but instead of throwing exceptions that are thrown by subcomputations,\n they are returned in a data structure.\n\u003c/p\u003e\u003cp\u003eAs a result, property 6 of \u003ccode\u003e\u003ca\u003eparallel_\u003c/a\u003e\u003c/code\u003e is not preserved, and therefore if your IO actions can depend on each other\n and may throw exceptions your program may die with \u003ca\u003eblocked indefinitely\u003c/a\u003e exceptions rather than informative messages.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Local",
        "fct-package": "parallel-io",
        "fct-signature": "Pool -\u003e [IO a] -\u003e IO [Maybe SomeException]",
        "fct-source": "src/Control-Concurrent-ParallelIO-Local.html#parallelE_",
        "fct-type": "function",
        "title": "parallelE_"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-module": "Control.Concurrent.ParallelIO.Local",
        "fct-package": "parallel-io",
        "fct-signature": "Pool -\u003e [IO (Maybe a)] -\u003e IO (Maybe a)",
        "fct-source": "src/Control-Concurrent-ParallelIO-Local.html#parallelFirst",
        "fct-type": "function",
        "title": "parallelFirst"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eAs \u003ccode\u003e\u003ca\u003eparallelFirst\u003c/a\u003e\u003c/code\u003e, but instead of throwing exceptions that are thrown by subcomputations,\n they are returned in a data structure.\n\u003c/p\u003e\u003cp\u003eAs a result, property 4 of \u003ccode\u003e\u003ca\u003eparallelFirst\u003c/a\u003e\u003c/code\u003e is not preserved, and therefore if your IO actions can depend on each other\n and may throw exceptions your program may die with \u003ca\u003eblocked indefinitely\u003c/a\u003e exceptions rather than informative messages.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Local",
        "fct-package": "parallel-io",
        "fct-signature": "Pool -\u003e [IO (Maybe a)] -\u003e IO (Maybe (Either SomeException a))",
        "fct-source": "src/Control-Concurrent-ParallelIO-Local.html#parallelFirstE",
        "fct-type": "function",
        "title": "parallelFirstE"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-package": "parallel-io",
        "fct-signature": "Pool -\u003e [IO a] -\u003e IO [a]",
        "fct-source": "src/Control-Concurrent-ParallelIO-Local.html#parallelInterleaved",
        "fct-type": "function",
        "title": "parallelInterleaved"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eAs \u003ccode\u003e\u003ca\u003eparallelInterleaved\u003c/a\u003e\u003c/code\u003e, but instead of throwing exceptions that are thrown by subcomputations,\n they are returned in a data structure.\n\u003c/p\u003e\u003cp\u003eAs a result, property 6 of \u003ccode\u003e\u003ca\u003eparallelInterleaved\u003c/a\u003e\u003c/code\u003e is not preserved, and therefore if your IO actions can depend on each other\n and may throw exceptions your program may die with \u003ca\u003eblocked indefinitely\u003c/a\u003e exceptions rather than informative messages.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Local",
        "fct-package": "parallel-io",
        "fct-signature": "Pool -\u003e [IO a] -\u003e IO [Either SomeException a]",
        "fct-source": "src/Control-Concurrent-ParallelIO-Local.html#parallelInterleavedE",
        "fct-type": "function",
        "title": "parallelInterleavedE"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        ...
        "fct-package": "parallel-io",
        "fct-signature": "Pool -\u003e IO ()",
        "fct-source": "src/Control-Concurrent-ParallelIO-Local.html#spawnPoolWorkerFor",
        "fct-type": "function",
        "title": "spawnPoolWorkerFor"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eA safe wrapper around \u003ccode\u003e\u003ca\u003estartPool\u003c/a\u003e\u003c/code\u003e and \u003ccode\u003e\u003ca\u003estopPool\u003c/a\u003e\u003c/code\u003e. Executes an \u003ccode\u003e\u003ca\u003eIO\u003c/a\u003e\u003c/code\u003e action using a newly-created\n pool with the specified number of threads and cleans it up at the end.\n\u003c/p\u003e",
        "fct-module": "Control.Concurrent.ParallelIO.Local",
        "fct-package": "parallel-io",
        "fct-signature": "Int -\u003e (Pool -\u003e IO a) -\u003e IO a",
        "fct-source": "src/Control-Concurrent-ParallelIO-Local.html#withPool",
        "fct-type": "function",
        "title": "withPool"
      },
      "index": {
