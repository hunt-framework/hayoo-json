[
  ...
  [
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eA minimal wrapper for \u003ccode\u003e\u003ca\u003eStorableArray\u003c/a\u003e\u003c/code\u003e that encodes the full\n dimensions of the array in the type. Intended for interfacing with\n (possibly-)multidimensional arrays of fixed size in native code.\n\u003c/p\u003e",
          "module": "Foreign.Marshal.FixedStorableArray",
          "name": "FixedStorableArray",
          "package": "fixed-storable-array",
          "source": "src/Foreign-Marshal-FixedStorableArray.html#FixedStorableArray",
          "type": "data"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eThe concrete bounds for this dimension\n\u003c/p\u003e",
          "module": "Foreign.Marshal.FixedStorableArray",
          "name": "bounds",
          "package": "fixed-storable-array",
          "signature": "FixedStorableArray d e -\u003e (Bound d, Bound d)",
          "source": "src/Foreign-Marshal-FixedStorableArray.html#bounds",
          "type": "method"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Foreign-Marshal-FixedStorableArray.html#fromNat",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eCreate a \u003ccode\u003e\u003ca\u003eFixedStorableArray\u003c/a\u003e\u003c/code\u003e and populate it with copies of the\n element passed in. Dimensions will be determined from the return\n type.\n\u003c/p\u003e",
          "module": "Foreign.Marshal.FixedStorableArray",
          "name": "newFixedStorableArray",
          "package": "fixed-storable-array",
          "signature": "e -\u003e IO (FixedStorableArray d e)",
          "source": "src/Foreign-Marshal-FixedStorableArray.html#newFixedStorableArray",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eCreate a \u003ccode\u003e\u003ca\u003eFixedStorableArray\u003c/a\u003e\u003c/code\u003e and don't populate it with anything\n in particular. Contents may or may not be initialized to anything\n at all. Dimensions will be determined from the return type.\n\u003c/p\u003e",
          "module": "Foreign.Marshal.FixedStorableArray",
          "name": "newFixedStorableArray_",
          "package": "fixed-storable-array",
          "signature": "IO (FixedStorableArray d e)",
          "source": "src/Foreign-Marshal-FixedStorableArray.html#newFixedStorableArray_",
          "type": "function"
        },
        "index": {
