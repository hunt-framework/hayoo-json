  ...
  [
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Pipes-Network-TCP-Safe.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003eaccept\u003c/a\u003e\u003c/code\u003e from \u003ca\u003eNetwork.Simple.TCP\u003c/a\u003e, but compatible\n with \u003ccode\u003e\u003ca\u003eMonadSafe\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
          "module": "Pipes.Network.TCP.Safe",
          "name": "accept",
          "package": "pipes-network",
          "signature": "Socket -\u003e ((Socket, SockAddr) -\u003e m r) -\u003e m r",
          "source": "src/Pipes-Network-TCP-Safe.html#accept",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003econnect\u003c/a\u003e\u003c/code\u003e from \u003ca\u003eNetwork.Simple.TCP\u003c/a\u003e, but compatible\n with \u003ccode\u003e\u003ca\u003eMonadSafe\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
          "module": "Pipes.Network.TCP.Safe",
          "name": "connect",
          "package": "pipes-network",
          "signature": "HostName -\u003e ServiceName -\u003e ((Socket, SockAddr) -\u003e m r) -\u003e m r",
          "source": "src/Pipes-Network-TCP-Safe.html#connect",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Pipes-Network-TCP-Safe.html#listen",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003eserve\u003c/a\u003e\u003c/code\u003e from \u003ca\u003eNetwork.Simple.TCP\u003c/a\u003e, but compatible\n with \u003ccode\u003e\u003ca\u003eMonadSafe\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
          "module": "Pipes.Network.TCP.Safe",
          "name": "serve",
          "package": "pipes-network",
          "signature": "HostPreference -\u003e ServiceName -\u003e ((Socket, SockAddr) -\u003e IO ()) -\u003e m r",
          "source": "src/Pipes-Network-TCP-Safe.html#serve",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003efromSocket\u003c/a\u003e\u003c/code\u003e, except the downstream pipe can specify the maximum\n number of bytes to receive at once using \u003ccode\u003e\u003ca\u003erequest\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
          "module": "Pipes.Network.TCP",
          "name": "fromSocketN",
          "package": "pipes-network",
          "signature": "Socket -\u003e Int -\u003e Server' Int ByteString m ()",
          "source": "src/Pipes-Network-TCP.html#fromSocketN",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003efromSocketN\u003c/a\u003e\u003c/code\u003e, except with the first \u003ccode\u003e\u003ca\u003eInt\u003c/a\u003e\u003c/code\u003e argument you can specify\n the maximum time that each interaction with the remote end can take. If such\n time elapses before the interaction finishes, then an \u003ccode\u003e\u003ca\u003eIOError\u003c/a\u003e\u003c/code\u003e exception is\n thrown. The time is specified in microseconds (10e6).\n\u003c/p\u003e",
          "module": "Pipes.Network.TCP",
          "name": "fromSocketTimeoutN",
          "package": "pipes-network",
          "signature": "Int -\u003e Socket -\u003e Int -\u003e Server' Int ByteString m ()",
          "source": "src/Pipes-Network-TCP.html#fromSocketTimeoutN",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eSends to the remote end each \u003ccode\u003e\u003ca\u003eByteString\u003c/a\u003e\u003c/code\u003e received from upstream.\n\u003c/p\u003e",
          "module": "Pipes.Network.TCP",
          "name": "toSocket",
          "package": "pipes-network",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eLike \u003ccode\u003e\u003ca\u003etoSocket\u003c/a\u003e\u003c/code\u003e, except with the first \u003ccode\u003e\u003ca\u003eInt\u003c/a\u003e\u003c/code\u003e argument you can specify\n the maximum time that each interaction with the remote end can take. If such\n time elapses before the interaction finishes, then an \u003ccode\u003e\u003ca\u003eIOError\u003c/a\u003e\u003c/code\u003e exception is\n thrown. The time is specified in microseconds (10e6).\n\u003c/p\u003e",
          "module": "Pipes.Network.TCP",
          "name": "toSocketTimeout",
          "package": "pipes-network",
          "signature": "Int -\u003e Socket -\u003e Consumer' ByteString m r",
          "source": "src/Pipes-Network-TCP.html#toSocketTimeout",
          "type": "function"
        },
        "index": {
