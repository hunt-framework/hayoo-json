[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eDefault main function, same as\n\u003c/p\u003e\u003cpre\u003e defaultMainWithHooks $ installGetTextHooks simpleUserHooks\n\u003c/pre\u003e",
        "fct-module": "Distribution.Simple.I18N.GetText",
        "fct-package": "hgettext",
        "fct-signature": "IO ()",
        "fct-source": "src/Distribution-Simple-I18N-GetText.html#gettextDefaultMain",
        "fct-type": "function",
        "title": "gettextDefaultMain"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eInstalls hooks, used by GetText module to install\n PO files to the system. Previous won't be disabled\n\u003c/p\u003e",
        "fct-module": "Distribution.Simple.I18N.GetText",
        "fct-package": "hgettext",
        "fct-signature": "UserHooks-\u003e UserHooks",
        "fct-type": "function",
        "title": "installGetTextHooks"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cdiv class=\"doc\"\u003e\u003cp\u003eThis library provides basic internationalization capabilities\n\u003c/p\u003e\u003c/div\u003e",
        "fct-module": "Text.I18N.GetText",
        "fct-package": "hgettext",
        "fct-signature": "module",
        "fct-source": "src/Text-I18N-GetText.html",
        "fct-type": "module",
        "title": "GetText"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ebindTextDomain sets the base directory of the hierarchy\n containing message catalogs for a given message domain.\n\u003c/p\u003e\u003cp\u003eThrows \u003ccode\u003e\u003ca\u003eIOError\u003c/a\u003e\u003c/code\u003e if fails\n\u003c/p\u003e",
        "fct-module": "Text.I18N.GetText",
        "fct-package": "hgettext",
        "fct-signature": "String-\u003e Maybe String-\u003e IO String",
        "fct-type": "function",
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003edGetText wraps GNU dgettext function. It works similar to \u003ccode\u003e\u003ca\u003egetText\u003c/a\u003e\u003c/code\u003e\n but also could take domain name.\n\u003c/p\u003e",
        "fct-module": "Text.I18N.GetText",
        "fct-package": "hgettext",
        "fct-signature": "Maybe String-\u003e String-\u003e IO String",
        "fct-type": "function",
        "title": "dGetText"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003edcGetText wraps GNU dcgettext function. It works similar to \u003ccode\u003e\u003ca\u003edGetText\u003c/a\u003e\u003c/code\u003e\n but also takes category id\n\u003c/p\u003e",
        "fct-module": "Text.I18N.GetText",
        "fct-package": "hgettext",
        "fct-signature": "Maybe String-\u003e Category-\u003e String-\u003e IO String",
        "fct-type": "function",
        "title": "dcGetText"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003edcnGetText wraps GNU dcngettext function. It works similar to \u003ccode\u003e\u003ca\u003ednGetText\u003c/a\u003e\u003c/code\u003e but\n also takes category id\n\u003c/p\u003e",
        "fct-module": "Text.I18N.GetText",
        "fct-package": "hgettext",
        "fct-signature": "Maybe String-\u003e Category-\u003e String-\u003e String-\u003e Integer-\u003e IO String",
        "fct-type": "function",
        "title": "dcnGetText"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003ednGetText wraps GNU dngettext function. It works similar to \u003ccode\u003e\u003ca\u003enGetText\u003c/a\u003e\u003c/code\u003e but\n also takes domain name\n\u003c/p\u003e",
        "fct-module": "Text.I18N.GetText",
        "fct-package": "hgettext",
        "fct-signature": "Maybe String-\u003e String-\u003e String-\u003e Integer-\u003e IO String",
        "fct-type": "function",
        "title": "dnGetText"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003enGetText wraps GNU ngettext function. It translates text string in the\n user's native language, by lookilng up the approppiate plural form of the\n message.\n\u003c/p\u003e",
        "fct-module": "Text.I18N.GetText",
        "fct-package": "hgettext",
        "fct-signature": "String-\u003e String-\u003e Integer-\u003e IO String",
        "fct-type": "function",
        "title": "nGetText"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003etextDomain sets domain for future \u003ccode\u003e\u003ca\u003egetText\u003c/a\u003e\u003c/code\u003e call\n\u003c/p\u003e\u003cp\u003eThrows \u003ccode\u003e\u003ca\u003eIOError\u003c/a\u003e\u003c/code\u003e if fails\n\u003c/p\u003e",
        "fct-module": "Text.I18N.GetText",
        "fct-package": "hgettext",
