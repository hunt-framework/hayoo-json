  ...
  [
    {
      ...
      "document": {
        "description": {
          ...
          "name": "LZ4",
          "package": "lz4",
          "source": "src/Codec-Compression-LZ4.html",
          "type": "module"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eCompresses a string.\n\u003c/p\u003e",
          "module": "Codec.Compression.LZ4",
          "name": "c_LZ4_compress",
          "package": "lz4",
          "signature": "Ptr CChar-\u003e Ptr Word8-\u003e CInt-\u003e IO CInt",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eWorst case compression bounds on an input string.\n\u003c/p\u003e",
          "module": "Codec.Compression.LZ4",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eCompresses a string with very high compression.\n\u003c/p\u003e",
          "module": "Codec.Compression.LZ4",
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eDecompresses a string. Works for both \u003ccode\u003e\u003ca\u003ec_LZ4_compress\u003c/a\u003e\u003c/code\u003e and\n \u003ccode\u003e\u003ca\u003ec_LZ4_compressHC\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
          "module": "Codec.Compression.LZ4",
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "source": "src/Codec-Compression-LZ4.html#compress",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          ...
          "package": "lz4",
          "signature": "ByteString -\u003e Maybe ByteString",
          "source": "src/Codec-Compression-LZ4.html#decompress",
          "type": "function"
        },
        "index": {
    ...
    },
    {
      ...
      "document": {
        "description": {
          "description": "\u003cp\u003eDecompress a string compressed with \u003ccode\u003e\u003ca\u003ecompressPlusHC\u003c/a\u003e\u003c/code\u003e. Essentially\n defined as:\n\u003c/p\u003e\u003cpre\u003e decompressPlusHC xs = decompress xs \u003e\u003e= decompress\n\u003c/pre\u003e",
          "module": "Codec.Compression.LZ4",
          "name": "decompressPlusHC",
          "package": "lz4",
          "signature": "ByteString -\u003e Maybe ByteString",
          "source": "src/Codec-Compression-LZ4.html#decompressPlusHC",
          "type": "function"
        },
        "index": {
