[
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eThe type that backs created Sieves. \n\u003c/p\u003e",
        "fct-module": "Data.Sieve",
        "fct-package": "sieve",
        "fct-signature": "data",
        "fct-source": "src/Data-Sieve.html#Sieve",
        "fct-type": "data",
        "title": "Sieve"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eThe function \u003ccode\u003e\u003ca\u003enewSieve\u003c/a\u003e\u003c/code\u003e is the preferred method of creating a new \u003ccode\u003e\u003ca\u003eSieve\u003c/a\u003e\u003c/code\u003e. The sieve that is constructed will immediately filter the list passed as the second parameter to \u003ccode\u003e\u003ca\u003enewSieve\u003c/a\u003e\u003c/code\u003e.\n\u003c/p\u003e",
        "fct-module": "Data.Sieve",
        "fct-package": "sieve",
        "fct-signature": "(a -\u003e Bool)-\u003e [a]-\u003e Sieve a",
        "fct-type": "function",
        "title": "newSieve"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eReturns the backing relation used to determine if a given element is a member of the list.\n\u003c/p\u003e",
        "fct-module": "Data.Sieve",
        "fct-package": "sieve",
        "fct-signature": "Sieve a -\u003e a -\u003e Bool",
        "fct-source": "src/Data-Sieve.html#relation",
        "fct-type": "function",
        "title": "relation"
      },
      "index": {
  ...
  },
  {
    ...
    "document": {
      ...
      "description": {
        "fct-descr": "\u003cp\u003eThe \u003ccode\u003e\u003ca\u003etoList\u003c/a\u003e\u003c/code\u003e function returns the resulting backing list.\n\u003c/p\u003e",
        "fct-module": "Data.Sieve",
        "fct-package": "sieve",
        "fct-signature": "Sieve a -\u003e [a]",
        "fct-source": "src/Data-Sieve.html#toList",
        "fct-type": "function",
        "title": "toList"
      },
      "index": {
